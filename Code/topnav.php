                                    ...
                                    <a role="button" data-toggle="dropdown" href="#" class="notif">
                                        ...
                                        <?php 
                                            ...
                                            if(strstr($job_title,"SUO")){                                                                          
                                                ...
                                                $prsql=mysqli_query($mysqli,"SELECT pr_date,pr_no FROM pms_pr WHERE pr_status='Pending' AND pr_sp_seen='0'");
                                                $prnum=mysqli_num_rows($prsql);
                                                if ($prnum > 0) {
                                                    $notif+=$prnum;
                                                }
                                                
                                                $posql=mysqli_query($mysqli,"SELECT po_date,po_no FROM pms_po WHERE po_status='Pending' AND po_sp_seen='0'");
...
<!--                                    <h4 class="menu-title pull-right">View all<i class="glyphicon glyphicon-circle-arrow-right"></i></h4>-->
                                       ...
                                       <?php 
                                        ...
                                        <a class="content" href="#">
                                            <div class="notification-item">
                                                ...
                                                <p class="item-info"><a href="modules/prs/admin/employee.php?gen=2">CLICK HERE TO GENERATE</a></p>
                                            </div>
                                        </a>   
                                            <?php
                                            }
                                        ...
                                        <a class="content" href="#">
                                            <div class="notification-item">
                                                ...
                                                <p class="item-info"><a href="modules/prs/admin/employee.php" style="text-decoration: none;"><font style="color: #185c92;font-size: 10px;font-weight: 600;">Go to Employee list</font></a></p>
                                                </div>
                                        </a>
                                            <?php
                                            }
                                            ...
                                            if(strstr($job_title,"HTEACH")){   
                                                ...
                                                <a class="content" href="modules/ipcrm/admin_DH/ipcrms_trans_rec.php">
                                                    <div class="notification-item">
                                        ...
                                        <?php	
                                                ...
                                                if($ntsql>0){
                                                    ...
                                                    while($norow=mysqli_fetch_assoc($notif)){ ?>
                                                <a class="content" href="modules/ipcrm/admin_SH/ipcrms_trans_rec.php ">
                                                    <div class="notification-item">
                                                        <h4 class="item-title"><?php echo $norow['Name'];?></h4>
                                        ...
                                        <?php          
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin/ris_page.php">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin/pr.php">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin/po.php">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin1/ris_request.php">
                                                <div class="notification-item">
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin1/requests.php">
                                                <div class="notification-item">
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin1/po_request.php">
                                                <div class="notification-item">
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/USER/trans.php">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="modules/SCMS/pages/stuper/index.php">Medical Records</a></li>
                                        <li><a href="modules/SCMS/pages/stuper/consult_history.php">Consultation History</a></li>
                                    </ul>
                                </li>    
                                        <?php        
                                            } 
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="admin/cpasswd.php">Change Password</a></li>
                                        <li role="separator" class="divider"></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="modules/SIS/stu/student_pi.php">My Profile</a></li>
                                        <li><a href="admin/cpasswd.php">Change Password</a></li>
                                        <li><a href="" data-toggle="modal" data-target="#logoutModal">Logout</a></li>
                                    </ul>
                                </li>
