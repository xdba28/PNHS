...
<body>
          ...
          <div class="modal-content" style="width: 400;" >
            ...
            <div class="modal-body" style="padding:20px 40px;">
                            ...
                            <tbody>
								...
								<tr>
									<td><center><a href="viewfile.php?month=<?php echo $month?>&&year=<?php echo $year?>&&type=<?php echo $table?>" target="_blank"><img src="../assets/images/payslip3.png" width="55px"></a></center></td>
									<td><center><a href="viewfile.php?month=<?php echo $month?>&&year=<?php echo $year?>&&type=<?php echo $registry?>" target="_blank"><img src="../assets/images/payslip2.png" width="55px"></a></center></td>
									<td><center><a href="viewfile.php?month=<?php echo $month?>&&year=<?php echo $year?>&&type=<?php echo $slip?> " target="_blank"><img src="../assets/images/payslip1.png" width="55px"></a></center></td>
								</tr>
							</tbody>
						</table>
            </div>
	...
	<!--=======END MODAL========-->
			 ...
			 <div class="container-fluid" style="height:auto;min-height:700px;max-width:100%;margin-right:20px;margin-left:20px;margin-bottom:10px">
					...
					<div class="col-lg-12">
				<h3 class="page-header"> <img  class="w3-hover-light-blue" style="margin-right: 2;border-radius: 50%;background-color: #fdfdfd " src="../assets/images/report.png" width="50px"><font size="6px" face="helvetica"><b>Payroll Reports</b></font>
				</h3>
					</div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel1"> <font size="6px" face="helvetica">
                            Pay Report For The Month Of <?php echo $month?> <?php echo $year?> </font>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                             ...
                             <?php 
							$qry= mysqli_query($mysqli,"SELECT * FROM pims_personnel, prs_report
													where monthname(prs_report.date_issued)='$month'
