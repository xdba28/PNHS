						...
						<div class="col-lg-12">
							<div class="panel panel-primary">
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-8">
											<a class="btn btn-primary pull-right form-control" href="edit_news.php?id=<?php echo $id; ?>">Edit</a>
											<br><br>
										...
										<div class="col-lg-4">
											<?php
												if(!empty($dir)) {
													echo '<img src="../uploads/'.$dir.'" class="img-responsive center-block">';
												}
												else {
													echo '<label for="">No Image Uploaded. </label>';
												}
											?>
											<br>
											<?php
												if(!empty($dir) AND $cap) {
													echo '<blockquote><footer><p><i>'.$cap.'</i></p></footer></blockquote>';
												}
												else {
													echo '<label for="">No Image Caption. </label>';
												}
											?>
										</div>
									</div>
