						...
						<div class="col-lg-12">
							<div class="panel panel-primary">
								<div class="panel-body">
									<h1>Edit: <i>
										<?php 
											$name = $desc = $date = $id = $acctid = $dir = '';
											$achvid = $mysqli->real_escape_string($_GET['id']);
											$achv_query="SELECT * FROM `cms_achievement` WHERE `cms_achievement_ID` = ".$achvid.";";
											$get_achv = $mysqli->query($achv_query);
											while($achv = $get_achv->fetch_assoc()) {
												$name = $achv['cms_achievement_name'];
												$desc = $achv['cms_achievement_about'];
												$date = $achv['cms_achievement_date'];
												$id = $achv['cms_achievement_ID'];
												$acctid = $achv['cms_account_id'];
												$dir = $achv['cms_img_dir'];
											}
											echo $name;
										?></i></h1>
									<?php
									...
									<div class="row">
										...
										<div class="col-md-10">
											<form id="register" action="_Sub/update_achievement.php" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<textarea class="ckeditor form-control" name="about" id="about"><?php echo $desc; ?></textarea>
												</div>
												<div class="form-group">
													<div class="row">
														<div class="col-lg-4">
