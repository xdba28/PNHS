								...
								<div class="panel-body">
									...
									<form action="" method="GET">
										<div class="row">
											<div class="col-lg-4">
												<select name="j" id="j" class="form-control">
													...
													<?php
														...
														$options = $values = $check = array();
														if($jt->num_rows > 0) {
															while($dt = $jt->fetch_assoc()) {
																if(!in_array($dt['job_title_code'], $values) AND !in_array($dt['job_title_name'], $options)) {
																	$a = $dt['job_title_code'];
																	$b = $dt['job_title_name'];
																	$b1 = trim($b);
																	$b2 = explode(" ", $b1);
																	array_push($check, $b2);
																	if(preg_match("/^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/", trim($b2[count($b2)-1]))) {
																		$b2[count($b2)-1] = preg_replace("/^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/", '', $b2[count($b2)-1]);
																		array_pop($b2);
																	}
																	$b2 = trim(implode(" ", $b2));
																	array_push($values, $a);
																	array_push($options, $b2);
																}
																//echo '<option value='.$a.'>'.$b.'</option>';
															}
															for($cnt1 = 0; $cnt1 < count($options); ++$cnt1) {
																$a = $values[$cnt1];
																$b = $options[$cnt1];
																echo '<option value='.$a.'>'.$b.'</option>';
															}
											...
											<?php //echo '<pre>'; echo print_r($check); echo '</pre>';?>
											<div class="col-lg-4">
									...
									<hr> -->
												<?php
													if(isset($_GET['j'])) {
														...
														$get_priv_query="SELECT cms_privilege.*, pims_job_title.job_title_name FROM pims_job_title, cms_privilege WHERE pims_job_title.job_title_code LIKE '$jtesc%' AND cms_privilege.job_title_code LIKE '$jtesc%' LIMIT 1";
														$get_priv = $mysqli->query($get_priv_query);
														$cnt1 = 1;
														while($priv = $get_priv->fetch_assoc()) {
															$b = $priv['job_title_name'];
															$b1 = trim($b);
															$b2 = explode(" ", $b1);
															array_push($check, $b2);
															if(preg_match("/^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/", trim($b2[count($b2)-1]))) {
															...
															$b2 = trim(implode(" ", $b2));
															echo '<form action="_Sub/update_usertype.php" method="POST"><h4>'.strtoupper($b2).'</h4>';
															echo '<div class="row">
																			<br>';
															if($priv['frms_priv'] == 1) {
															...
															if($priv['pms2_priv'] == 1) {
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="PMS" checked="">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
																...
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="PMS">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
															...
															if($priv['pims2_priv'] == 1) {
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="PIMS" checked="">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
																...
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="PIMS">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
															...
															if($priv['prs2_priv'] == 1) {
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="PRS" checked="">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
																...
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="PRS">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
															...
															if($priv['ipcrms2_priv'] == 1) {
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="IPCRMS" checked="">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
																...
																echo '<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
																				...
																				<center>
																					<label class="switch">
																						<input type="checkbox" value="2" name="IPCRMS">
																						<span class="slider round"></span>
																					</label>
																				</center>
																			</div>';
															...
															echo '<div class="form-group">
																<div class="row">
																	...
																	<div class="col-lg-4">
																		<button type="submit" name="update" value="'.$priv['job_title_code'].'" class="btn btn-primary form-control">Update '.$b2.' Privileges</button>
																	</div>
																</div>
															</div></form>';
															echo '<hr>';
