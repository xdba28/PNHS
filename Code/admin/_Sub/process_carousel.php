					...
					if(in_array($fileActualExt, $allowed)) {
						if($fileError === 0) {
							if($fileSize < 2000000) {
								...
								$img_query="INSERT INTO `cms_image` (`cms_image_ID`, `cms_album_ID`, `cms_image_name`, `cms_image_dir`, `cms_image_date`) VALUES (NULL, '12', '$fileNameNew', '$fileDestination', CURRENT_DATE());";
