<?php
	...
	if(isset($_SESSION['user_data'])) {
			if(isset($_POST['pswd']) AND isset($_POST['npswd']) AND isset($_POST['spswd'])) {
				...
				if($pswd==$pwd) {
					if($npswd==$spswd) {
						...
						$_SESSION['msg']='Re-typed New Password does not match the New Password.';
						header('Location: ../cpasswd.php');
						die();
					}
				}
