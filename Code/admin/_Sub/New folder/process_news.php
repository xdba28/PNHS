<?php
	...
	if(isset($_SESSION['user_data'])) {
			if(isset($_POST['submit']) AND isset($_POST['title']) AND isset($_POST['date']) AND isset($_POST['desc'])) {
				...
				$news_query="INSERT INTO `cms_news` (`cms_news_ID`, `cms_title`, `cms_news_description`, `cms_news_date`, `cms_account_id`, `cms_news_img_dir`, `cms_news_img_cap`, `cms_news_writer`) VALUES ('', '$title', '$desc', '$date', '$acct_id', '$fileDestination', '$cap', '$auth');";
