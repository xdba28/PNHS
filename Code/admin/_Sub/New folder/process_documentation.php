<?php
	...
	if(isset($_SESSION['user_data'])) {
			if(isset($_POST['submit']) AND isset($_POST['id']) AND isset($_POST['aln'])) {
					...
					if(in_array($fileActualExt, $allowed)) {
						if($fileError === 0) {
							if($fileSize < 2000000) {
								...
								$img_query="INSERT INTO `cms_image` (`cms_image_ID`, `cms_album_ID`, `cms_image_name`, `cms_image_dir`, `cms_album_name`, `cms_image_date`) VALUES (NULL, '$id', '$fileNameNew', '$fileDestination', '$aln', CURRENT_DATE());";
