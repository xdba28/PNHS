<?php
	...
	if(isset($_SESSION['user_data'])) {
			if(isset($_POST['submit']) AND isset($_POST['subj']) AND isset($_POST['date']) AND isset($_POST['desc'])) {
				...
				$news_query="INSERT INTO `cms_memo` (`cms_memo_ID`, `cms_subject`, `cms_memo_description`, `cms_memo_date`, `cms_account_id`, `cms_memo_pdf_dir`, cms_memo_date_created, cms_memo_time_created) VALUES (NULL, '$subj', '$desc', '$date', '8', '$fileDestination', CURRENT_DATE(), CURRENT_TIME());";
