										...
										<div class="row">
											<div class="col-lg-12">
												<div class="row">
													<div class="col-lg-12">
														<div class="embed-responsive embed-responsive-4by3">
															<iframe class="embed-responsive-item" src="<?php echo $get_content; ?>"></iframe>
														</div>
													</div>
												</div>
												<hr>
												<div class="row">
													<div class="col-lg-12">
														<br>
														<form action="_Sub/update_calendar.php" method="POST">
														<div class="form-group">
															<label for="exampleInputEmail1">Google Calendar Link:</label>
															<div class="row">
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														    		<input type="text" class="form-control" name="glink" id="glink" value="<?php echo $get_content; ?>">
																</div>
																<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
																	<button type="submit" class="btn btn-primary form-control" name="submit">Save Link</button>
																</div>
															</div>
														</div>
														</form>
