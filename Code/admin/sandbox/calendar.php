...
<html lang="en" >
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Calendar | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Calendar | PAG-ASA National High School" />
		<meta property="og:site_name" content="Calendar | PAG-ASA National High School" />
	  	<meta name="description" content="Calendar | PAG-ASA National High School">
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="w3-container w3-theme-bd5 w3-card-2">
						<center><h2>School Calendar</h2></center>
					</div>
					<br>
					<div class="row">
						<div class="col-lg-12">
