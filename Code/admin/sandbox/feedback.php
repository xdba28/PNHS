...
<html lang="en" >
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Feedback | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Feedback | PAG-ASA National High School" />
		<meta property="og:site_name" content="Feedback | PAG-ASA National High School" />
	  	<meta name="description" content="Feedback | PAG-ASA National High School">
					...
					<div class="col-lg-8">
						<div class="row">
							<div class="col-lg-12">
								...
								<br>
								<div class="row">
									<form id="register" action="admin/_Sub/submit_fback.php" method="POST" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
									<div class="w3-row w3-section">
									  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
									    <div class="w3-rest">
									      <input class="w3-input w3-border" name="name" type="text" placeholder="Visitor's Fullname">
									    </div>
									</div>
									...
									<div class="w3-row w3-section">
									  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-envelope-o"></i></div>
									    <div class="w3-rest">
									      <input class="w3-input w3-border" name="email" type="text" placeholder="Email Address">
									    </div>
									</div>
									...
									<div class="w3-row w3-section">
									  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-pencil"></i></div>
									    <div class="w3-rest">
									      <textarea class="w3-input" style="height:120px" w3-border name="message" placeholder="Message"></textarea>
									    </div>
									</div>

									<button class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding" name="fbf" id="fbf">Send</button>
