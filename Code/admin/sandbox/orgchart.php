...
<html lang="en">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Organizational Chart | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Organizational Chart | PAG-ASA National High School" />
		<meta property="og:site_name" content="Organizational Chart | PAG-ASA National High School" />
	  	<meta name="description" content="Organizational Chart | PAG-ASA National High School">
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="w3-container w3-theme-bd5 w3-card-2">
						<center><h2>Organizational Chart</h2></center>
					</div>
					<?php
										$result_num = 20;
										if(isset($_GET['q'])) {
					...
					<br>
					<div class="row">
										<form action="admin/_Sub/ss_orgchart_idx.php" method="GET">
											<div class="col-lg-8">
															...
															if(isset($_GET['q']) AND !empty($_GET['q'])) {
																...
																if($get_org->num_rows > 0) {
																	while($org = $get_org->fetch_assoc()) {
																		...
																		<a target="_blank" href="uploads/orgchart/'.$img.'">
																		<p class="lead pull-left"><b>'.$title.'<b></p>
																		<img class="img-responsive center-block" src="uploads/orgchart/'.$img.'"></a>
																		<br>
																		</td></tr>';
																	}
																}
