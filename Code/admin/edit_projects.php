																	...
																	if($get_img->num_rows > 0) {
																		...
																		if(!empty($title)) {
																			...
																			echo '<p><b>Untitled</b> - <small>'; echo dateFormat($date); echo'</small></p>';
																						...
																						echo '<td class="bg-info text-center"><a href="edit_proj_cap.php?id='.$imgid.'" class=""><span class="glyphicon glyphicon-edit"></span> Edit </a></td>';
																						echo '<td class="bg-danger text-center"><a href="_Sub/delete_projects.php?id='.$imgid.'" class=""><span class="glyphicon glyphicon-trash"></span> Delete </a></td>';
																			echo '</tr>';
																		}
																	}
																	else {
