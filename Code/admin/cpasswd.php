									...
									<div class="row">
										...
										<div class="col-lg-8">
											...
											<div class="alert alert-info" role="alert">
											  <a class="alert-link">If you are new to your account we recommend you to change your password. <br><br>Make sure your Password cannot easily be guessed by others.</a>
											</div>
											</div>
											</div>
											<br>
											<form id="register" action="_Sub/process_cpasswd.php" method="POST">
												...
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
													...
													<input class="form-control" type="password" name="pswd" id="pswd"<?php if(isset($_SESSION['q'])) { echo ' value="'.$_SESSION['q'].'"'; } ?>>
												</div>
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
													<label>New Password:</label>
													<input class="form-control" type="password" name="npswd" id="npswd"<?php if(isset($_SESSION['w'])) { echo ' value="'.$_SESSION['w'].'"'; } ?>>
												</div>
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
													<label>Re-type New Password:</label>
													<input class="form-control" type="password" name="spswd" id="spswd"<?php if(isset($_SESSION['e'])) { echo ' value="'.$_SESSION['e'].'"'; } ?>>
												</div>
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
