																	...
																	while($img = $get_img->fetch_assoc()) {
																		...
																		echo '<td>
																						<div class="media">
																							...
																							<a id="mediatable">
																									<div class="row">
																										<div class="col-lg-10" data-toggle="modal" data-target="#'.$imgid.'">
																											<h4 class="media-heading"><b class="b-title">';
																		if(!empty($title)) {
																		...
																		echo '</b></h4>
																										...
																										echo '</div>
																										<div class="col-lg-2">
																											<a href="edit_sp_cap.php?id='.$imgid.'" class="btn btn-info form-control"><span class="glyphicon glyphicon-edit"></span> Edit </a>
																											<a href="_Sub/delete_sp.php?id='.$imgid.'" class="btn btn-danger form-control"><span class="glyphicon glyphicon-trash"></span> Delete </a>
																										</div>
																									</div>';
																								echo '</a>
				...
				messages: {
					'file[]': {
						...
						maxupload: '<p class="text-danger">Maximum number of files per upload is 20.</p>',
              			filesize: '<p class="text-danger">File(s) must be less than 5MB</p>'
					}
				}
			});
		</script>
