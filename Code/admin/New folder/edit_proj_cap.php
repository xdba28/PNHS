							...
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									...
									<div class="row">
										...
										?>
										<div class="col-lg-8">
											<form id="register" action="_Sub/update_proj_cap.php" method="POST">
												<label for="cap">New Project Name: </label>
												<input class="form-control" type="text" name="name" id="name" value="<?php echo $iname; ?>">
												<br>
												<label for="cap">New Caption: </label>
												<textarea class="ckeditor form-control" for="cap" name="cap" id="cap"><?php echo $cap; ?></textarea>
