						...
						<div class="col-lg-12">
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-12">
											<form action="_Sub/process_mission.php" method="POST" enctype="multipart/form-data">
												<div class="form-group">
													<label for="desc">Description</label>
													<textarea class="ckeditor form-control" name="misn"> <?php echo $get_content[2]; ?> </textarea>
												</div>
												<div class="form-group">
													<div class="row">
														<div class="col-lg-4">
