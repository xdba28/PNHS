						...
						<div class="col-lg-12">
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									<h1>GPTA Officers</h1>
									<hr>
									<form action="_Sub/process_gpta.php" method="POST" enctype="multipart/form-data">
		                            <div class="row">
		                            <?php
		                            ...
		                            <div class="row">
		                              <div class="col-lg-12">
		                                <textarea class="ckeditor form-control" name="gpta"> <?php echo $get_content[8]; ?> </textarea>
		                              </div>
		                            </div>
		                            <div class="row">
		                              <div class="col-lg-8">
