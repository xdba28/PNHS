								...
								<div class="panel-body">
									...
									<div class="row">
										<?php
											...
											$getal=$mysqli->real_escape_string($_GET['al']);
										...
										?>
										<div class="col-lg-8">
											<form id="register" action="_Sub/update_doc_cap.php" method="POST">
												<label for="cap">New Caption: </label>
												<textarea for="cap" class="form-control" name="cap"><?php echo $cap; ?></textarea>
												<input type="hidden" name="id" value="<?php echo $getid; ?>">
												<input type="hidden" name="al" value="<?php echo $getal; ?>">
												<br>
