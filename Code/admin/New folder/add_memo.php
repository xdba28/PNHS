							...
							<div class="panel panel-primary">
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-md-10">
											<form id="register" action="_Sub/process_memo.php" method="POST" enctype="multipart/form-data">
												<div class="form-group">
													<div class="row">
														<div class="col-lg-6">
															<label for="subj">Subject: </label>
															<input class="form-control" type="text" id="subj" name="subj">
														</div>
														<div class="col-lg-6">
												...
												<div class="form-group">
													<div class="row">
														<div class="col-lg-6">
															<label for="imgup">Upload PDF:</label>
												...
												<div class="form-group">
													<div class="row">
														...
														<div class="col-lg-4">
															<button type="submit" class="btn btn-info form-control" name="submit">Submit</button>
														</div>
													</div>
												</div>
											</form>
		...
		<script>
			...
			$("#register").validate({
				...
				messages: {
					...
					file: {
						required: '<p class="text-danger">This field is required.</p>',
						extension: '<p class="text-danger">Invalid File Type(s) (png, jpg(jpeg), gif).</p>',
