						...
						<div class="col-lg-12">
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-4">
											<a class="btn btn-primary form-control" href="../shs.php">View Senior High School Page</a>
										</div>
									</div>
									<hr>
									<div class="row">
										<div class="col-lg-12">
											<form id="register" action="_Sub/process_shs.php" method="POST" enctype="multipart/form-data">
												<div class="form-group">
													<label for="hist">Description</label>
													<textarea class="ckeditor form-control" name="shs" id="shs"> <?php echo $get_content; ?> </textarea>
												</div>
												<div class="form-group">
													<div class="row">
														<div class="col-lg-4">
