						...
						<div class="col-lg-12">
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									...
									<div class="row">
									<?php
											$img_query="SELECT * FROM `cms_carousel`;";
											$get_img = $mysqli->query($img_query);
											$cnt=1;
											while($img = $get_img->fetch_assoc()) {
												$imgid = $img['cms_carousel_ID'];
												$name = $img['cms_carousel_name'];
												$date = dateFormat($img['cms_carousel_date']);
												echo '<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 img-thumb">
																<div class="thumbnail">
																	...
																	<a href="../uploads/header/'.$name.'" data-lightbox="carousel" data-title="">
																		<img src="../uploads/header/'.$name.'" alt="" class="img-padding img-responsive center-block">
																	</a>
																	<div class="caption">
