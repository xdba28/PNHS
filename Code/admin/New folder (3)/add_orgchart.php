						...
						<div class="col-lg-12">
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									...
									<hr>
									<form id="register" action="_Sub/process_orgchart.php" method="POST" enctype="multipart/form-data">
											<div class="row">
												<div class="col-lg-6">
												...
												<div class="col-lg-6">
													...
													<div class="row">
														<div class="col-lg-6">
															<input type="text" class="form-control" id="sy1" placeholder="YYYY" name="sy1">
														</div>
														<div class="col-lg-6">
															<input class="form-control" type="text" id="sy2" placeholder="YYYY" name="sy2">
														</div>
													</div>
												</div>
											</div>
