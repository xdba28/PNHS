						...
						<div class="col-lg-12">
							<div class="panel panel-primary sidepanel">
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-4">
											<a class="btn btn-primary form-control" href="../principal.php">View Principal's Corner Page</a>
										</div>
									</div>
									<hr>
									<form id="register1" action="_Sub/process_principal.php" method="POST" enctype="multipart/form-data">
										<div class="row">
											<div class="form-group">
													...
													<div class="col-xs-12 col-sm-4 col-lg-4">
														<button type="button" class="btn btn-primary form-control" data-toggle="modal" data-target="#confirmation1">Upload Image</button>
													</div>
													<div class="col-xs-12 col-sm-4 col-lg-4">
													</div>
											</div>
											<div class="modal fade" id="confirmation1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
													<div class="modal-dialog" role="document">
														<div class="modal-content">
																...
																<div class="modal-footer">
																	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																	<button type="submit" class="btn btn-primary" name="p_file">Save</button>
																</div>
														</div>
													</div>     
												</div>
										...
										<?php
											...
											while($img = $get_img->fetch_assoc()) {
												...
												if(!empty($dir)) {
													echo '<div class="col-lg-4"><label for="">Current Image:</label><a class="pull-right text-danger" href="_Sub/delete_principal_img.php?a=1"><span class="glyphicon glyphicon-trash"></span><b>&nbspDelete</b></a><div class="thumbnail">';
													...
													echo '<br><div class="col-lg-4"><label for="">No Image Uploaded. </label></div>';
												}
											}
										?>
										</div>
									...
									<hr>
									<form id="register2" action="_Sub/process_principal.php" method="POST" enctype="multipart/form-data">
										<div class="row">
											<div class="col-lg-6">
										...
										<?php
											$cont_query = "SELECT * FROM `cms_principal` LIMIT 1;";
										...
										<div class="modal fade" id="confirmation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
													<div class="modal-dialog" role="document">
														<div class="modal-content">
																...
																<div class="modal-footer">
																	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																	<button type="submit" class="btn btn-primary" name="p_con">Save</button>
																</div>
														</div>
													</div>     
												</div>
