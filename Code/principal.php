...
<html lang="en" >
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Principal's Corner | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Principal's Corner | PAG-ASA National High School" />
		<meta property="og:site_name" content="Principal's Corner | PAG-ASA National High School" />
	  	<meta name="description" content="Principal's Corner | PAG-ASA National High School">
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="w3-container w3-theme-bd5 w3-card-2">
						<center><h2>Principal's Corner</h2></center>
					</div>
					<br>
					<div class="row">
						<div class="col-lg-12 text-justify">
						<?php
							$cont_query = "SELECT * FROM `cms_principal`;";
							$get_cont = $mysqli->query($cont_query);
							if($get_cont->num_rows > 0) {
								while($cont = $get_cont->fetch_assoc()) {
									$dir = $cont['cms_principal_img_dir'];
									$name = $cont['cms_principal_name'];
									$rank = $cont['cms_principal_rank'];
									$cont = $cont['cms_principal_content'];
					...
					<div class="row">
							...
							if($get_img->num_rows > 0) {
								...
								while($img = $get_img->fetch_assoc()) {
									...
									if(!empty($name) OR !empty($rank) OR !empty($cont) OR !empty($dir)) {
										$print_principal .= '</div>';
										$print_principal .= '<div class="w3-container w3-theme-bd5 w3-card-2">
