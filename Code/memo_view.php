...
<html lang="en" >
	<head>
		...
		<?php
			$title2 = $desc2 = $date2 = $id2 = $dir2 = NULL;
			$newsid = base64_decode($mysqli->real_escape_string($_GET['id']));
			if(is_numeric($newsid)) {
				$news_query="SELECT * FROM `cms_memo` WHERE `cms_memo_ID` = ".$newsid.";";
				$get_news = $mysqli->query($news_query);
				if($get_news->num_rows > 0) {
					while($news = $get_news->fetch_assoc()) {
						$title2 = $news['cms_subject'];
						$desc2 = $news['cms_memo_description'];
						$date2 = $news['cms_memo_date'];
						$id2 = $news['cms_memo_ID'];
		...
		?>
	  	<title><?php echo $title2.' | '; ?>PAG-ASA National High School</title>
		...
		<meta property="og:title" content="<?php echo $title2.' | '; ?>PAG-ASA National High School" />
		<meta property="og:site_name" content="<?php echo $title2.' | '; ?>PAG-ASA National High School" />
		<meta name="description" content="<?php echo $title2.' | '; ?>PAG-ASA National High School">
						...
						<div class="col-lg-12 text-justify">
							<?php
								if(is_numeric($newsid)) {
									if($get_news->num_rows > 0) {
							?>
							<h1><b><?php echo $title2; ?></b></h1>
									<p><i><?php echo dateFormat($date2); ?></i></p>
									<hr>
									<div class="row">
											<div class="col-lg-12">
												<p><?php echo $desc2; ?></p>
												...
												<div class="embed-responsive embed-responsive-4by3">
													<iframe class="embed-responsive-item" src="<?php echo 'uploads/'.$pdf; ?>" type="application/pdf"></iframe>
												</div>
											</div>
									</div>
							<?php
