				...
				<div class="panel panel-default" style="width:700px; float: left; position: static">
                        <div class="panel-body">
						   ...
						   <label class="col-sm-4 control-label"><font face="helvetica" size="5px"><b>YEAR:</b></font></label>
								...
								<?php 
								$allowanceselect = mysql_query("SELECT  year(date_change) as allowanceyear, setting_id as id FROM  prs_setting where name_setting = 'Allowance'  group by year(date_change)");
								
								while($allowancerow = mysql_fetch_assoc($allowanceselect))
								{
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <div class="tab-pane fade" id="gsis">
                                    ...
                                    <h3 class="page-header"><i class="fa fa-money" aria-hidden="true"></i>&nbsp GSIS Changes</h3>	
							<div class="panel1">
                            <div style="width: 50%;">
						   <label class="col-sm-4 control-label"><font face="helvetica" size="5px"><b>YEAR:</b></font></label>
										<div class="form-group input-group">
								...
								<option>Select Year</option>
								<?php 
								$gsisselect = mysql_query("SELECT  year(date_change) as gsisyear, setting_id as id FROM  prs_setting where name_setting = 'GSIS'  group by year(date_change)");
								
								while($gsisrow = mysql_fetch_assoc($gsisselect))
								{
                        ...
                        <div class="panel-body">
							...
							<br><br>
							<h3 class="page-header"><i class="fa fa-money" aria-hidden="true"></i>&nbsp GSIS Remittance</h3>	
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example6">
                                ...
                                <div class="tab-pane fade" id="pagibig">
                                    <h3 class="page-header"><i class="fa fa-money" aria-hidden="true"></i>&nbsp PAGIBIG Changes</h3>	
							<div class="panel1">
                            <div style="width: 50%;">
						   <label class="col-sm-4 control-label"><font face="helvetica" size="5px"><b>YEAR:</b></font></label>
										<div class="form-group input-group">
                        ...
                        <div class="panel-body">
							...
							<br><br>
							<h3 class="page-header"><i class="fa fa-money" aria-hidden="true"></i>&nbsp PAGIBIG Remittance</h3>	
							<div class="panel1">  <div style="float:right;"  ><a href="record.php"><img  class="w3-hover-light-blue" style="margin-right: 2;border-radius: 47%;background-color: #fdfdfd" src="../assets/images/records.png" width="43px"></a></div> 
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example6">
                                ...
                                <div class="tab-pane fade" id="philhealth">
                                    <h3 class="page-header"><i class="fa fa-money" aria-hidden="true"></i>&nbsp PhilHealth Changes</h3>	
							<div class="panel1">
                            <div style="width: 50%;">
						   <label class="col-sm-4 control-label"><font face="helvetica" size="5px"><b>YEAR:</b></font></label>
										<div class="form-group input-group">
                        ...
                        <div class="panel-body">
							...
							<br><br>
							<h3 class="page-header"><i class="fa fa-money" aria-hidden="true"></i>&nbsp PhilHealth Remittance</h3>	
							<div class="panel1">  <div style="float:right;"  ><a href="record.php"><img  class="w3-hover-light-blue" style="margin-right: 2;border-radius: 47%;background-color: #fdfdfd" src="../assets/images/records.png" width="43px"></a></div> 
						...
						<div class="panel-body" style="width:300px; float: right; height:auto;">
                            <div class="list-group" style="height:auto;">
								...
								<a href="#" class="list-group-item" style="padding-bottom: 10">
									...
									<em>
									<?php 
									  $getdateph = mysqli_query($mysqli,"select * from prs_setting group by date_change DESC limit 1  ");
										$rowpht = mysqli_fetch_assoc($getdateph);
										$phdate = get_timeago(strtotime($rowpht['date_change']));
