...
<html lang="en" >
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Hymn | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Hymn | PAG-ASA National High School" />
		<meta property="og:site_name" content="Hymn | PAG-ASA National High School" />
	  	<meta name="description" content="Hymn | PAG-ASA National High School">
	...
	<body onload="myFunction()">
        ...
        <div id="wrapper"> 
			...
			<ol class="breadcrumb">
				...
				<li class="active">PNHS Hymn</li>
			</ol>
			<div class="row">
				<div class="col-lg-8">
					<div class="w3-container w3-theme-bd5 w3-card-2">
						<center><h2>Pag-Asa National High School Hymn</h2></center>
					</div>
					<br>
					<div class="row">
						<div class="col-lg-12 text-justify">
							<?php
								$cont_query = "SELECT * FROM `cms_site_content` WHERE `cms_content_label` = 'hymn';";
