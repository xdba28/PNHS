...
<html lang="en" >
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Vision and Mission | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Vision and Mission | PAG-ASA National High School" />
		<meta property="og:site_name" content="Vision and Mission | PAG-ASA National High School" />
	  	<meta name="description" content="Vision and Mission | PAG-ASA National High School">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="row">
						...
						<?php
							$cont_query = "SELECT * FROM `cms_site_content` WHERE `cms_content_label` = 'vision';";
					...
					<div class="row">
						<div class="col-lg-12 text-justify">
							<?php
									$cont_query = "SELECT * FROM `cms_site_content` WHERE `cms_content_label` = 'mission';";
									$get_cont = $mysqli->query($cont_query);
									if($get_cont->num_rows > 0) {
										while($cont = $get_cont->fetch_assoc()) {
											echo $cont['cms_content_desc'];
