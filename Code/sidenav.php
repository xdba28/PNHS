 ...
 <!-- CMS -->
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    ...
                                    <ul class="nav nav-fourth-level">
                                        ...
                                        <li><a href="admin/orgchart.php"><i class="fa fa-fw fa-circle-o"></i>Organizational Chart</a></li>
                                        <li><a href="admin/gpta.php"><i class="fa fa-fw fa-circle-o"></i>GPTA Officers</a></li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li><a href="admin/edit_footer.php"><i class="fa fa-fw fa-code"></i>Footer</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-user-secret"></i>Account Management<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li><a href="admin/usertype_settings.php"><i class="fa fa-fw fa-circle-o"></i>Usertype Settings</a></li>
                                <li>
                                    <a href="#"><i class="fa fa-fw fa-image"></i>Account Modification<span class="fa arrow"></span></a>
                                    <ul class="nav nav-fourth-level">
                                        <li><a href="admin/personnel_accounts.php"><i class="fa fa-fw fa-user-secret"></i>Personnel Accounts</a></li>
                                        <li><a href="admin/student_accounts.php"><i class="fa fa-fw fa-user-secret"></i>Student Accounts</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li><a href="admin/feedback.php"><i class="fa fa-fw fa-circle-o"></i>Feedback</a></li>
                    </ul>
                </li>
                <?php
                    }
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-third-level">
                            ...
                            <li>
                                <a href="../../pims/admin/all_personnel.php"><i class="fa fa-fw fa-circle-o"></i>All PNHS Personnel</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="modules/prs/admin/employee.php?gen=1"><i class="fa fa-fw fa-spin fa-spinner"></i>Generate Payroll</a>
                    </li>
                    <?php
        ...
        <li>
            ...
            <ul class="nav nav-second-level">   
                ...
                <?php
                        ...
                        if($ch>0){ ?>
                <li>
                    <a href="modules/scms/pages/stuper/class_bmi.php"><i class="fa fa-fw fa-th-list"></i> BMI Record</a>
                </li>
                    <?php        
                        }
                    ?>
                <li>
                    <a href="modules/scms/pages/stuper/index.php"><i class="fa fa-fw fa-th-list"></i> Medical Record</a>
                </li>
                <li>
                    <a href="modules/scms/pages/stuper/consult_history.php"><i class="fa fa-fw fa-history"></i> Consultation History</a>
                </li>
                <?php
                    }
                ?>    
