<?php 
    ...
    function definePerson($id) {
        ...
        $sql=$mysqli->query("SELECT css_priv, frms_priv, ims_priv, ipcrms_priv, pims_priv, pms_priv, oes_priv, prs_priv, scms_priv, sis_priv, cms_account.emp_no, pims_employment_records.job_title_code, faculty_type FROM pims_personnel, pims_employment_records, pims_job_title, cms_privilege, cms_account WHERE cms_account.emp_no = pims_personnel.emp_no AND pims_personnel.emp_no = pims_employment_records.emp_no AND pims_employment_records.job_title_code = pims_job_title.job_title_code AND cms_account.cms_account_id = '$id' AND cms_privilege.job_title_code = pims_employment_records.job_title_code");
        $row=$sql->fetch_assoc();
    ...
    function defineStudent($id) {
        //Gamitin kung connected na sa database
        include("php/connection.php");
        $sql=$mysqli->query("SELECT css_priv, frms_priv, ims_priv, ipcrms_priv, pims_priv, pms_priv, oes_priv, prs_priv, scms_priv, sis_priv, cms_account.lrn FROM cms_privilege, cms_account, sis_student WHERE cms_account.lrn = sis_student.lrn AND cms_account.cms_account_id=$id");
        $row=$sql->fetch_assoc();
        //Teaching User
        $css_priv=$row['css_priv'];//view scheds
        $dms_priv=$row['frms_priv'];//view docs
