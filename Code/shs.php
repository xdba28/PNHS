...
<html lang="en" >
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	  	<title>Senior High School | PAG-ASA National High School</title>
		...
		<meta property="og:title" content="Senior High School | PAG-ASA National High School" />
		<meta property="og:site_name" content="Senior High School | PAG-ASA National High School" />
	  	<meta name="description" content="Senior High School | PAG-ASA National High School">
				...
				<div class="col-lg-8">
					...
					<div class="row">
						<div class="col-lg-12 text-justify">
							<?php
								$cont_query = "SELECT * FROM `cms_site_content` WHERE `cms_content_label` = 'senior high school';";
