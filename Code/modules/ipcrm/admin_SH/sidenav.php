                ...
                <?php 
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">    
                            ...
                            <li>
                                <a href="../../ipcrm/admin_SH/ipcrms_trans_rec.php"><i class="fa fa-fw fa-list"></i>Request List</a>
                            </li>
                            <li>
                                <a href="../../ipcrm/admin_SH/ipcrms_set_deadline.php"><i class="fa fa-fw fa-clock-o"></i>Set Deadline</a>
                            </li>
                        </ul>
                    </li>    
                <?php            
