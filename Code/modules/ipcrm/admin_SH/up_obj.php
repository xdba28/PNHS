				...
				<div class="container-fluid">
					...
					<!--	<table class="table table-condensed table-hover table-bordered table-responsive">
						...
						<?php
							...
							$id=$_GET['id'];
							$qry = mysql_query("Select ipcrms_kra.KRA_ID, ipcrms_obj.OBJ_ID, ipcrms_obj.obj_desc, ipcrms_kra.KRA_description from ipcrms_obj, ipcrms_kra, ipcrms_mfo where ipcrms_mfo.MFO_ID =".$id." and ipcrms_kra.MFO_ID = ipcrms_mfo.MFO_ID and ipcrms_kra.KRA_ID = ipcrms_obj.KRA_ID");
							if($qry){
								while($row=mysql_fetch_array($qry)){
									...
									echo '
											...
											<tr>
												<td><input type="text" class="form-control" name="obj" value="'.$obj_desc.'"/><td>
												<input type="hidden" value="'.$obj_id.' name="kra_id" />
					...
					<form action="up_process.php" method="get">
						<table class="table table-hover table-responsive table-condensed">
							...
							<?php 
								$id=$_GET['id'];
								$qry = mysql_query("Select * from ipcrms_obj where ipcrms_obj.KRA_ID = ".$id."");
								if($qry){
									while($row=mysql_fetch_array($qry)){
										...
										echo'
											<tr>
												...
												<td><input name="kra" value ="'.$kra_desc.'" type="text" class="form-control" /></td>
