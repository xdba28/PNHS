<?php 
    ...
    function definePerson($id){
        ...
        $sql=mysql_query("SELECT css_priv,frms_priv,ims_priv,ipcrms_priv,pims_priv,pms_priv,oes_priv,prs_priv,scms_priv,sis_priv,cms_account_type,cms_privilege.cms_account_id,cms_account.emp_no,pims_employment_records.job_title_code,faculty_type
        ...
        $sql2=mysql_query("SELECT pims_employment_records.dept_id 
