    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <nav style="max-width:100%" class="hidden-xl hidden-lg hidden-md hidden-sm">
            <ul class="sidebar-menu">
              <li class="sidebar-header">MN</li>
              <li>
                <a href="#">
                  <i class="fa fa-dashboard"></i> <span>Dashboard</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="sidebar-submenu">
                  <li><a href="../../index.html"><i class="fa fa-circle-o"></i> Form</a></li>
...
<div class="row">
    ...
    <div class="w3-container w3-btheme w3-card-2">
        <h2 align="left">LIST OF DEPARTMENTS</h2>
    </div>
     <div class="w3-container w3-text-btheme">
<p> </p>    </div>

<ul class="w3-ul w3-border-top">
<center>
  <li class="w3-theme-bl3">
    <p>
        <a href="#"> Araling Panlipunan Department
    </p>
  </li>
  <li class="w3-theme-bl4">
    <p>
        <a href="#"> English Department
    </p>
  </li>
  <li class="w3-theme-bl3">
    <p>
        <a href="#"> ESP Department
    </p>
  </li>    
  <li class="w3-theme-bl4">
    <p>
        <a href="#"> Filipino Department
    </p>
  </li>
  <li class="w3-theme-bl3">
    <p>
        <a href="#"> ICT Department
    </p>
  </li>
  <li class="w3-theme-bl4">
    <p>
        <a href="#"> Mathematics Department
    </p>
  </li>
  <li class="w3-theme-bl3">
    <p>
        <a href="#"> Science Department
    </p>
  </li>
    </center>
</ul>
