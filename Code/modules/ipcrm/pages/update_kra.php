...
<div class="w3-container w3-theme-bl4">
     <ul class="nav navbar-nav navbar-center">
        <li><a href="update_kra.php">KRAdggh</a></li>
					...
					<div class="vessel">
						<div class="row">
							<div class="col-lg-6">
								...
								<?php
									$id=$_GET['id'];
									$query="SELECT * FROM `KRA` WHERE `question_ID`='$id'";
									$q_query=mysql_query($query);
									$data=mysql_fetch_assoc($q_query);
								?>
								<input type="hidden" name="id" value="<?php echo $id; ?>">
								<label class="control-label" for="question1">Category ID:</label>
								
								<select name="question1" id="" class="form-control" required>
									<?php
									$cat=$_GET['cat'];
								...
								<br>
								<label class="control-label" for="question2">KRA Description:</label>
								<textarea class="form-control" type="textfield" name="question2"><?php echo $data['question_desc']; ?></textarea>
								<br>
								<input class="btn btn-primary btn-md" type="submit" name="submitnewquestion" value="Update KRA">
								...
								<?php
									if(isset($_GET['submitnewquestion']))
									{
										//$update1=$_POST['question1'];
										$id=$_GET['id'];
										$update1=$_GET['question1'];
										$update2=mysql_escape_string($_GET['question2']);
										$query="UPDATE `fes_question` SET `category_ID` = '$update1', `question_desc`='$update2' WHERE `fes_question`.`question_ID`='$id';";
										//echo $query;
										mysql_query($query);
									
										//echo "<script>location.href='#.php';
										//	alert('KRA is successfully updated! '); </script>";
										echo "<script>sweetAlert({
											  type:'success',
											  title: 'Question is successfully updated!',
											  });</script>";
