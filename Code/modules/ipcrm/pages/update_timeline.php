					...
					<div class="vessel">
						<div class="row">
							<div class="col-lg-6">
								...
								<label class="control-label" for="timeline1">Category ID:</label>
								
								<select name="timeline1" id="" class="form-control" required>
									<?php
									$cat=$_GET['cat'];
								...
								<br>
								<label class="control-label" for="timeline2">Timeline Description:</label>
								<textarea class="form-control" type="textfield" name="timeline2"><?php echo $data['timeline_desc']; ?></textarea>
								<br>
								<input class="btn btn-primary btn-md" type="submit" name="submitnewobjectives" value="Update Timeline">
								...
								<?php
									if(isset($_GET['submitnewtimeline']))
									{
										//$update1=$_POST['timeline1'];
										$id=$_GET['id'];
										$update1=$_GET['timeline1'];
										$update2=mysql_escape_string($_GET['timeline2']);
										$query="UPDATE `timeline` SET `category_ID` = '$update1', `timeline_desc`='$update2' WHERE `timeline`.`timeline_ID`='$id';";
										//echo $query;
										mysql_query($query);
									
										//echo "<script>location.href='#.php';
										//	alert('Timeline is successfully updated! '); </script>";
										echo "<script>sweetAlert({
											  type:'success',
											  title: 'Timeline is successfully updated!',
											  });</script>";
