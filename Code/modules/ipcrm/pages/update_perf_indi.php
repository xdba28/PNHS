					...
					<div class="vessel">
						<div class="row">
							<div class="col-lg-6">
								...
								<?php
									$id=$_GET['id'];
									$query="SELECT * FROM `performance` WHERE `performance_ID`='$id'";
								...
								<br>
								<label class="control-label" for="weight2">Performance Indicator Description:</label>
								<textarea class="form-control" type="textfield" name="performance"><?php echo $data['performance_desc']; ?></textarea>
								<br>
								<input class="btn btn-primary btn-md" type="submit" name="submitnewperformance" value="Update Performance Indicator">
								...
								<?php
									if(isset($_GET['submitnewperformance']))
									{
										//$update1=$_POST['performance1'];
										$id=$_GET['id'];
										$update1=$_GET['performance1'];
										$update2=mysql_escape_string($_GET['performance2']);
										$query="UPDATE `performance` SET `category_ID` = '$update1', `performance`='$update2' WHERE `performance`.`performance_ID`='$id';";
										//echo $query;
										mysql_query($query);
