    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <nav style="max-width:100%" class="hidden-xl hidden-lg hidden-md hidden-sm">
            <ul class="sidebar-menu">
              ...
              <li>
                <a href="#">
                  <i class="fa fa-dashboard"></i> <span>Forms</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="sidebar-submenu">
                  <li><a href="index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                  <li><a href="../../index2.html"><i class="fa fa-circle-o"></i> Form</a></li>
                </ul>
              </li>
              <li>
                <a href="#">
        ...
        <div class="navbar navbar-fixed-top" style="width:200px; margin-top:56px">
            <ul class="sidebar-menu">
              ...
              <li>
                ...
                <ul class="sidebar-submenu">
                  <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> Form</a></li>
                  <li><a href="../charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
                  <li><a href="../charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
                  <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
                </ul>
...
<div class="container-fluid" style="height:700px;max-width:100%;margin-top:70px;margin-right:20px;margin-left:20px;margin-bottom:10px">
    ...
    <center>    
    <a href="ipcrms_view.php">         
    <button type="button" class="btn btn-primary">
        <h3 font-family: "";>View Form</h3>   
    </button>
    </a>   
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="ipcrms_update.php">         
    <button type="button" class="btn btn-primary">
        <h3 font-family: "";>Update Form</h3>   
    </button>
    </a>    
    </center>
     </div>
