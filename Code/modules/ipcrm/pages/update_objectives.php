					...
					<div class="vessel">
						<div class="row">
							<div class="col-lg-6">
								...
								<?php
									$id=$_GET['id'];
									$query="SELECT * FROM `Objectives` WHERE `objectives_ID`='$id'";
									$q_query=mysql_query($query);
									$data=mysql_fetch_assoc($q_query);
								?>
								<input type="hidden" name="id" value="<?php echo $id; ?>">
								<label class="control-label" for="objectives1">Category ID:</label>
								
								<select name="objectives1" id="" class="form-control" required>
									<?php
									$cat=$_GET['cat'];
								...
								<br>
								<label class="control-label" for="objectives2">Objectives Description:</label>
								<textarea class="form-control" type="textfield" name="objectives2"><?php echo $data['objectives_desc']; ?></textarea>
								<br>
								<input class="btn btn-primary btn-md" type="submit" name="submitnewobjectives" value="Update Objectives">
								...
								<?php
									if(isset($_GET['submitnewobjectives']))
									{
										//$update1=$_POST['question1'];
										$id=$_GET['id'];
										$update1=$_GET['objectives1'];
										$update2=mysql_escape_string($_GET['question2']);
										$query="UPDATE `objectives` SET `category_ID` = '$update1', `objectives_desc`='$update2' WHERE `objectives`.`objectives_ID`='$id';";
										//echo $query;
										mysql_query($query);
									
										//echo "<script>location.href='#.php';
										//	alert('Ojectives is successfully updated! '); </script>";
										echo "<script>sweetAlert({
											  type:'success',
											  title: 'Objectives is successfully updated!',
											  });</script>";
