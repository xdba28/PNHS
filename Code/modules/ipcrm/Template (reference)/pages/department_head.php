       ...
       <button type="button" class="navbar-toggle collapsed fa fa-bars hidden-sm hidden-md hidden-lg" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="department_head.php"><i class="fa fa-home fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Department Rating<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="rating_master.php">Teachers Profile</a>
                                </li>
                                <li>
                                    <a href="rating_teacher.php">Rating</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                                       </div>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <center>
                        <img src="science.jpg" width="950px" height="200px"/>
                    </center>    
