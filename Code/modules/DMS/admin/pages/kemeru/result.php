...
<div class="row">
    <div class="col-lg-2 col-md-3 col-sm-3 hidden-xs">
        <div class="navbar navbar-fixed-top" style="width:200px; margin-top:56px">
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="#">
                      <i class="glyphicon glyphicon-folder-open"></i> <span>Documentss</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="sidebar-submenu">
                        <li><a href="form.php?dc=sr"><i class="fa fa-circle-o"></i> Service Record</a></li>
                        <li>
    ...
    <div class="col-lg-10 col-md-9 col-sm-9">
        <div class="container-fluid" style="height:700px;max-width:100%;margin-top:70px;margin-right:20px;margin-left:20px;margin-bottom:10px">
            <div class="row">
                <div class="col-md-2">
                    <img class="img-responsive" src="docs/img/fr-05.jpg">
                </div>
                <div class="col-md-4">
                    <h3>Emmanuel Candia Guim III</h3>
                    <h4>Teacher II</h4>
                </div>
                <div class="col-md-2">
                    <h3>Date retired: </h3><h4>10/01/17</h4>
                </div>
                <div class="col-md-1">
                    <br>
                    <a href="#" class="btn btn-danger disabled" >ARCHIVED</a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h4>School File 1</h4>
                    <img class="img-responsive" src="docs/img/SF1.png">
                    
                </div>
                <div class="col-md-4">
                    <h4>School File 2</h4>
                    <img class="img-responsive" src="docs/img/SF2.png">
                </div>
                <div class="col-md-4">
                    <h4>School File 5</h4>
                    <img class="img-responsive" src="docs/img/SF5.png">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h4>Quarterly Grades</h4>
                    <img class="img-responsive" src="docs/img/quarter_ss.JPG">
                    
                </div>
                <div class="col-md-6">
                    <h4>Master Grading Sheet</h4>
                    <img class="img-responsive" src="docs/img/master_ss.JPG">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <img class="img-responsive" src="docs/img/service_ss.JPG">
