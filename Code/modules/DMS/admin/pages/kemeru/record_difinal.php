                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            ...
                            <ul class="sidebar-submenu" style="display: none;">
                                ...
                                <li><a href="fixed.html"><i class="fa fa-circle-o"></i> Approved Request</a></li>
                                <li class="">
                                    <a href="collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Denied Request</a>
                                </li>
                            </ul>
                        </li>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu" style="display: none;">
                        ...
                        <li><a href="create.php"><i class="fa fa-circle-o"></i> Add Request</a></li>
                        <li><a href="fixed.html"><i class="fa fa-circle-o"></i> Approved Request</a></li>
                        <li class=""><a href="collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Denied Request</a>
                        </li>
                    </ul>
                </li>
