...
<div class="row">
    ...
    <div class="col-lg-10 col-md-9 col-sm-9">
        <div class="container-fluid" style="height:700px;max-width:100%;margin-top:70px;margin-right:20px;margin-left:20px;margin-bottom:10px">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-comments fa-fw"></i>Document Status</h1>
                </div>
                        <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <?php
                            $role=mysqli_query($mysqli,"SELECT dms_message.mes_id,concat(p_fname,' ',ifnull(p_mname,''),' ',p_lname) as Name,doc_type,sent,mes_stat FROM pims_personnel,pims_employment_records,cms_account,dms_document,dms_message,dms_receiver
                            WHERE pims_personnel.emp_No=pims_employment_records.emp_No
                            AND pims_personnel.emp_No=cms_account.emp_no
                            AND dms_message.doc_id=dms_document.doc_id
                            AND dms_message.cms_account_id=cms_account.cms_account_ID
                            AND dms_receiver.rec_no=dms_message.rec_no
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                        while($rowl=mysqli_fetch_assoc($role)){?>
                                        <tr>
                                            <td><?php echo $rowl['Name'];?></td>
                                            <td><?php echo $rowl['doc_type'];?></td>
                                            <td><?php echo $rowl['sent'];?></td>
                                            <?php
                                                if($rowl['mes_stat']=="A"){
                                                    echo "<td><span class='label label-success'>Approved</span></td>";
                                                }else if($rowl['mes_stat']=="D"){
