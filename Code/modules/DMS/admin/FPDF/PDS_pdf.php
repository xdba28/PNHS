        ...
        $pdf->Cell(50,5,"",1,0,"L");
          ...
          $pdf->Cell(70,5,"$mother_mname",1,0,"L");
           ...
           $pdf->Cell(90,5,"(Continue on separate sheet if necessary)",1,1,"C");
            ...
            $tertiary_degrees=$row['tertiary_degrees'];
            $pdf->Cell(27.14,5,"$tertiary_degrees",1,0,"C");
            $pdf->Cell(13.57,5,"",1,0,"C");
            $pdf->Cell(13.57,5,"",1,0,"C");
            ...
            $gradStud_school=$row['gradStud_school'];
            $pdf->Cell(32.14,5,"$gradStud_school",1,0,"C");
            $gradStud_course=$row['gradStud_course'];
            $pdf->Cell(27.14,5,"$gradStud_course",1,0,"C");
            $pdf->Cell(13.57,5,"",1,0,"C");
            $pdf->Cell(13.57,5,"",1,0,"C");
            $pdf->Cell(27.14,5,"Masteral",1,0,"C");
            $gradStud_yr=$row['gradStud_yr'];
            $pdf->Cell(22.14,5,"$gradStud_yr",1,0,"C");
            $honor_or_award=$row['honor_or_award'];
            $pdf->Cell(27.14,5,"$honor_or_award",1,1,"C");
