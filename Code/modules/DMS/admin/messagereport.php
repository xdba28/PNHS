      ...
      <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container">
                ...
                <div class="col-md-10">
                    <h1 class="page-header"><img class="img-responsive" src="../docs/img/MessageReport2.png"></h1> 
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <form method="POST">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php 
                                    if($rep=='stat'){
                                        $report=$mysqli->query("SELECT mes_stat,state_date,concat(p_fname,' ',p_lname) as Name from dms_message,cms_account,dms_receiver,dms_doc_type,pims_personnel
                                        ...
                                        while($reprow=$report->fetch_assoc()){
                                            ...
                                            if($reprow['mes_stat']=='A'){
                                                ...
                                                if($date1==$date){
                                                    echo "<tr>";
                                                        echo"<td>You <span class='alert-success'><i>Approved</i></span> ".$reprow['Name']."'s request today at $time. </td>";
                                                    echo "</tr>";
                                                }else if($date1==$yesterday){
                                                    echo "<tr>";
                                                        echo"<td>You <span class='alert-success'><i>Approved</i></span> ".$reprow['Name']."'s request yesterday at $time. </td>";
                                                    echo "</tr>";
                                                }else{
                                                    echo "<tr>";
                                                        echo"<td>You <span class='alert-success'><i>Approved</i></span> ".$reprow['Name']."'s request last $m $d,$y at $time. </td>";
                                                    echo "</tr>";
                                                }
                                                ...
                                                if($date1==$date){
                                                    echo "<tr>";
                                                        echo"<td>You <span class='alert-danger'><i>Denied</i></span> ".$reprow['Name']."'s request today at $time. </td>";
                                                    echo "</tr>";
                                                }else if($date1==$yesterday){
                                                    echo "<tr>";
                                                        echo"<td>You <span class='alert-danger'><i>Denied</i></span> ".$reprow['Name']."'s request yesterday at $time. </td>";
                                                    echo "</tr>";
                                                }else{
                                                    echo "<tr>";
                                                        echo"<td>You <span class='alert-danger'><i>Denied</i></span> ".$reprow['Name']."'s request last $m $d,$y at $time. </td>";
                                                    echo "</tr>";
                                                }
                                            }
