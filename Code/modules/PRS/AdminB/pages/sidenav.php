...
<nav class="navbar navbar-inverse navbar-fixed-top navigation-side" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar scrollbar sidebar-nav" id="style-4">
        ...
        <!-- CSS -->
            <?php 
                if($css_priv=="1" || $user_type=="superadmin"){ ?>
        <li>
            ...
            <ul>
                <ul class="nav collapse dropdown-submenu" id="subsubmenu13" role="menu">
                    <?php
                        echo'<li><a href="../../../css/admin/year_level.php?m=1" onclick="modalFunction(this.value)"><i class="fa fa-circle-o"></i> Create</a></li>';
                    ?>
            ...
            <ul>
                <ul class="nav collapse dropdown-submenu" id="subsubmenu14" role="menu">
                    <li><a data-toggle="tooltip" data-placement="right" title="View schedules per year level"  href="../../../css/admin/year_level.php" onclick="modal_dont_show(this.value)"><i class="fa fa-circle-o"></i> Year Level</a></li>
            ...
            <?php 
                ...
                <li>
                    ...
                    <ul class="nav collapse dropdown-menu" role="menu" id="submenu8">
                        ...
                        <?php
                        $query_lastmonth1=mysql_query("SELECT * FROM prs_report where month(date_issued) = month(now()) and year(date_issued)= year(now())");
                         $know_if_available1= mysql_num_rows($query_lastmonth1);
                        if($know_if_available1 > 0){ ?>
                        <li>
