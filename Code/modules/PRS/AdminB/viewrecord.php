...
<body>
      ...
      <div id="wrapper">
        ...
        <!-- /#sidebar-wrapper -->
			...
			<div class="row">
		<div class="col-lg-12">
		<h3 class="page-header"><img  class="w3-hover-light-blue" style="margin-right: 2;border-radius: 50%;background-color: #fdfdfd " src="../assets/images/setting.png" width="46px"><font size="6"><b>View Personnel MTR Record</b></font></h3>
	 	</div>
			</div>
			  ...
			  <br><br><br>
		        ...
		        <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel1">
                           <font face="helvetica" size="5px">Personnel MTR Record</font>
                        </div>
						<!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                           <?php 
								$selectrecord = mysqli_query($mysqli,"SELECT * FROM prs_dtr_rec where personnel_id='$getid'");
