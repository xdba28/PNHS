        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content" style="width: 400;" >
            ...
            <div class="modal-body" style="padding:20px 40px;">
                            ...
                            <tbody>
								<tr>
									<td><center><a href="paytable.php" target="_blank"><img src="../assets/images/payslip3.png" width="55px"></a></center></td>
									<td><center><a href="registry.php" target="_blank"><img src="../assets/images/payslip2.png" width="55px"></a></center></td>
									<td><center><a href="print.php" target="_blank"><img src="../assets/images/payslip1.png" width="55px"></a></center></td>
								</tr>
							</tbody>
						</table>
            </div>
	...
	<!--=======END MODAL========-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel1">
                           <font size="6px" face="helvetica"> <?php echo $date = date('F');?> Payroll Report  </font>
