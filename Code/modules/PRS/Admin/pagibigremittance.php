...
<table border="0">
    ...
    ';
	  ...
	  $queryemp = mysqli_query($mysqli,"SELECT pims_personnel.P_fname, pims_personnel.P_mname, pims_personnel.P_lname, pims_personnel.P_extension_name,  prs_report.rep_pi_total, pims_personnel.PAG_IBIG_id FROM pims_personnel, prs_report WHERE	monthname(prs_report.date_issued) = '$month'
	...
	$querytotal = mysqli_query($mysqli, "SELECT sum(prs_report.rep_pi_total) as pi_total FROM pims_personnel, prs_report WHERE	monthname(prs_report.date_issued) = '$month'
										AND year(prs_report.date_issued) = '$year' 
    ...
    <tr>
        ...
        <td colspan="2" border="1" align="center" style="font-size:9;">'.$month.' '.$year.'</td>
