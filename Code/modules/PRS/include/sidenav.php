            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                     ...
                     <?php
                    $check= mysqli_query($mysqli,"SELECT * FROM pims_personnel, prs_report 
                ...
                ?>
					...
					<li>
                        <a href=""  data-toggle="modal" data-target="#generate"><i class="fa fa-fw fa-spin fa-spinner"></i>Generate Payroll</a>
                    </li>
					<?php	}else{?>
					<li>	
						<a href=""  data-toggle="modal" data-target="#generate" style=" display: block;
    font-size: 15px;
    border-style: groove;
    border-left-color: #fde400;
    border-bottom-color: #ea4646;
    border-top-color: #ea4646;
	border-right-color: #ea4646;
    left: 1px;
    color: #ffffff;
    background-color: #851717;" ><i class="fa fa-fw fa-spin fa-spinner"></i>Generate Payroll</a>
					</li>	
					<?php } ?>
                    <?php
