                                ...
                                <li class="dropdown-notif">
                                  ...
                                  <ul class="dropdown-menu notifications" role="menu" aria-labelledby="dLabel">
                                    ...
                                    <div class="notification-heading">
                                        <h4 style="font-size: 15px"class="menu-title">Notifications</h4>
                                       ...
                                       <?php 
                                        ...
                                        <a class="content" href="#">
                                            <div class="notification-item">
                                                <h5 style="font-size:0.95rem;" class="item-title">Last Month's Pay was not generated</h5>
                                                <p class="item-info"><a href="../../prs/admin/employee.php?gen=2">CLICK HERE TO GENERATE</a></p>
                                            </div>
                                        </a>   
                                            <?php
                                            }
                                        ...
                                        <a class="content" href="#">
                                            <div class="notification-item">
                                                <h4 style="font-size:0.99rem;" class="item-title">This month's attendance was not submitted </h4>
                                            </div>
                                        </a>
                                            <?php
                                                }
