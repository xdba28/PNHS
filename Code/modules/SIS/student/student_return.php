...
<html lang="en" >
    ...
    <div class="container" style="max-width:1128px;font-size:12px;margin-left:15px">
        <h1 class="page-header w3-center">Change Student's Status</h1>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example"> 
                            <center>
                            <h4>Status:</h4>
                            <select style="margin: 0px 0px 10px 5px" name="status" id="status" form="form_check">
                            <option value=""> -- </option>
                            ...
                            <option value="Pending Section">Pending Section</option>
                            <?php
                            // while($row = mysqli_fetch_array($get_all_section))
                            // {
                            //     echo
                            ...
                            <tbody>
							<!-- <input id="checkAll" type="chechbox">
							<td></td>
							<td></td>
							<td></td> -->
                            <?php
							...
							$get_student = $mysqli->query("SELECT lrn, stu_lname, stu_fname, stu_mname, stu_status FROM sis_student")
                                ...
                                while($rew = mysqli_fetch_array($get_student))
                                {
                                    $lrn = $rew['lrn'];
                                    echo '<td><center>
                                    <input form="form_check" type="checkbox" name="stu[] id="stu[]" value=' . $rew['lrn'] . '></td>
                                    <td>' . $rew['lrn'] . '</td>
                    ...
                    ?>
                        ...
                        <center>
                        <form action="student_status_val.php" method="post" enctype="multipart/form-data" id="form_check">
