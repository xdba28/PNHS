                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="General">
                        ...
                        <div class="table-responsive">
							...
							<br>
                            <button onclick="validate()" class="btn w3-hover-green btn-success w3-card-2" type="submit" >
                            <i class="fa fa-check">
							</i>&nbsp;Submit</button>
                    ...
                    <div class="tab-pane" id="Parents">
                        ...
                        <div class="table-responsive">
                            ...
                            <br>
                            <button ondblclick="validate()" class="btn w3-hover-green btn-success w3-card-2" type="submit" >
                            <i class="fa fa-check">
                            </i>&nbsp;Submit</button>
