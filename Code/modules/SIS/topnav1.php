                ...
                <div class="container-full">
                        ...
                        <div class="row"> 
                            <div class="col-md-2">
                                <div class="navbar-header">
                                    ...
                                    <a href="index.php"><img style="width:210px;" src="img/pnhs_logo_3.png"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        About Us<span class="cart caret"></span>
                                    </a>
                            ...
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Programs <span class="cart caret"></span></a>
                                    <ul class="dropdown-menu">
                                       ...
                                       <?php 
                                        ...
                                        <a class="content" href="#">
                                            <div class="notification-item">
                                                ...
                                                <p class="item-info"><a href="modules/prs/admin/payrolrep.php?gen=2">CLICK HERE TO GENERATE</a></p>
                                            </div>
                                        </a>   
                                            <?php
                                            }
                                        ...
                                        <?php          
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin/ris_page.php?seen=1">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin/pr.php?seen=1">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="modules/IPMS/PMS/admin/po.php?seen=1">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
