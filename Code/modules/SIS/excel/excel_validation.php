...
<div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="../pages/sis_index.html">SIS Page</a></li>
...
<a id="back-to-top" href="#" class="w3-circle w3-card-4" alt="Return to Top" data-toggle="tooltip" data-placement="left">
    ...
    <div class="container">
        <h1 class="page-header w3-center">Excel Import Validation</h1>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default w3-card-4">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead class="w3-theme-bl1">
                                <tr>
                                    ...
                                    <th>Mother</th>
                                    <th>Guardian</th>
                                    <th>Transfer_in_Date</th>
                                    <th>Enrollment_Discription</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr><td><center><button class="w3-card-4 w3-theme-rl1 w3-hover-red w3-xsmall" style="border:0;margin-right:10px;margin-right:10px"><i class="fa fa-close"></i></button><button class="w3-card-4 w3-theme-bl1 w3-hover-blue w3-xsmall" style="border:0;margin-right:10px"><i class="fa fa-edit"></i></button></center></td>
                                ...
                                <tr>
                                    <td><center><button class="w3-card-4 w3-theme-rl1 w3-hover-red w3-xsmall" style="border:0;margin-right:10px"><i class="fa fa-close"></i></button><button class="w3-card-4 w3-theme-bl1 w3-hover-blue w3-xsmall" style="border:0;margin-right:10px"><i class="fa fa-edit"></i></button></center></td>
                                    <td>03831</td>
                                    <td>Luces</td>
                                    <td>Karen Mae</td>
                                    <td>Dioneda</td>
                        ...
                        <center>
                            <div class="btn w3-card-4 w3-large w3-hover-green btn-success" style="margin-bottom:20px" data-toggle="modal" data-target="#myModal">
