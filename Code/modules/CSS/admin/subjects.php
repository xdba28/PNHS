...
*/
$depart = mysqli_query($conn, "SELECT * FROM pims_department WHERE dept_ID != 16 AND dept_ID != 15 AND dept_ID != 14 AND dept_ID != 13");
        ...
        <div id="wrapper" style = "height:115%">
            <?php include("../sidenav.php"); ?>	
                ...
                <div class="container" style="min-height:800px">
					<center><h2 style="padding-bottom: 30px; padding-top: 50px"> Adding / Removing of Subjects<br> </h2></center>
						   ...
						   <div class="col-md-5">
							 <div class="panel panel-default">
							   ...
							   <div class="panel-body">
								 <form class="form-horizontal" action="add_sub.php" method="POST">
									<div class="form-group"> 
									   <label for="inputEmail3" class="col-md-4 control-label" style="margin-left:-32px">Dept. &nbsp;&nbsp;&nbsp;:</label>
									   <div class="col-md-8">
								   ...
								   <div class="form-group"> 
									   <label for="inputEmail3" class="col-md-4 control-label" style="margin-left:-32px"> Code &nbsp;&nbsp;&nbsp;&nbsp;:</label>
									   <div class="col-md-8">
											<input class="form-control" name="sub_name" type="text" required=""></input>
									   </div>
									</div>

									<div class="form-group"> 
									   <label for="inputEmail3" class="col-md-4 control-label" style="margin-left:-32px"> Desc. &nbsp;&nbsp;&nbsp;:</label>
									   <div class="col-md-8">
											<input class="form-control" name="sub_desc" type="text" required=""></input>
									   </div>
									</div>
						 ...
						 <div class="row"><br>	 
						   <div class="col-md-5">
							 <div class="panel panel-default">
							   ...
							   <div class="panel-body">
								 <form class="form-horizontal" action="del_sub.php" method="post">
								   <div class="form-group"> 
									   ...
									   <div class="col-md-8">
											 <select class="form-control" name = "sub_id" required="">
												  ...
												  <?php
												  foreach ($sub as $key) {
												  	if($key['subject_id']==50007 || $key['subject_id']==50005 || $key['subject_id']==50013 || $key['subject_id']==50009 || $key['subject_id']==50006 || $key['subject_id']==50012 || $key['subject_id']==50008 || $key['subject_id']==50010){
