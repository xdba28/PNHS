                      ...
                      <label class="control-label" for="name-input-field" style="padding-left: 105px">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                          <label class="btn btn-info active">
                            <input type="checkbox" value="" name="day[]" checked autocomplete="off">Reg.
                          </label>
                  ...
                  <div class="col-md-10 col-md-offset-1">
                    <br>
                      <div>
                        ...
                        <div class="btn-group" data-toggle="buttons">
                          <label class="btn btn-info active">
                            <input type="checkbox" checked autocomplete="off">Reg.
                          </label>
                          <label class="btn btn-info">
...
<!-- Modals button -->   
                           ...
                           <a  href="save_process.php"> 
                            <button class="a btn btn-sm  save" style="margin-right:5px; margin-top:5px">
                            ...
                            <button class="a create btn btn-sm" type="button" data-toggle="modal" data-target="#CModal" style="margin-right:5px; margin-top:5px">
...
<div class="container">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#<?php echo $grade7?>">Grade 7</a></li>
    <li><a data-toggle="tab" href="#<?php echo $grade8?>">Grade 8</a></li>
    <li><a data-toggle="tab" href="#<?php echo $grade9?>">Grade 9</a></li>
    <li><a data-toggle="tab" href="#<?php echo $grade10?>">Grade 10</a></li>
  </ul>

  <div class="tab-content">
  <!-- GRADE 7 -->	  
    <div id="#<?php echo $grade7?>" class="tab-pane fade in active">
    <?php $_SESSION['grade'] = $grade7; ?>
...
<!-- GRADE 8 -->	  
	<div id="<?php echo $grade8?>" class="tab-pane fade">

  <?php 
  session_start(); 
  $_SESSION['grade'] = $grade8;?>
	<table class="table"><br>	
                        <thead>
                          <tr class="headings">
                            <th class="column-title" style="text-align: center;font-size:13px">Time </th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">12:30-1:20</th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">1:20-2:10</th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">2:10-3:00</th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">3:10-4:00</th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">4:00-4:50</th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">4:50-5:40</th>
                            <th rowspan="2" class="column-title" style="padding-bottom:20px;">5:40-6:30</th> 
                          </tr>
                            <tr>
                              <th class="time col-md-1 " style="font-size:13px; text-align:center; padding-top:10px">Room # & Section</th> 
                            </tr>
...
<!-- GRADE 9 START -->
    <div id="<?php echo $grade9e?>" class="tab-pane fade">
    <?php $_SESSION['grade'] = $grade9;?>
	<table class="table"><br>	
                        <thead>
                          <tr class="headings">
                            <th class="column-title" style="text-align: center;font-size:13px">Time </th>
