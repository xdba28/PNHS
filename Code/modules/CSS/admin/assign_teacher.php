							   ...
							   <div class="panel-body">
								...
								?>
									...
									<div class="form-group">
									   <label for="inputEmail3" class="col-md-4 control-label" style="margin-left:-10px">Teacher &nbsp;&nbsp;&nbsp;:</label>
									   <div class="col-md-8" >
											<select class="form-control" name="teach_id" id="select2" required="">
							 ...
							 <div class="panel panel-default">
							   ...
							   <div class="panel-body">
								 <form class="form-horizontal" action="del_assign_process.php" method="post">
								   <div class="form-group"> 
									   <label for="inputEmail3" class="col-md-4 control-label" style="margin-left:-10px">Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
									   <div class="col-md-8">
								   ...
								   <div class="form-group"> 
									   ...
									   <div class="col-md-8 " id="teach2">
											<select class="form-control " name="teach_id" required="" id="select21">
												<option value="">Select</option>
											</select> 
									   </div>
									</div>
