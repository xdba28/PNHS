        ...
        <div class="navbar navbar-fixed-top" style="width:200px; margin-top:56px">
            <ul class="sidebar-menu">
              ...
              <li>
                ...
                <ul class="sidebar-submenu" style="display: none;">
                  <?php echo'
                  <li><a href="year_level.php?yr='.$yr.'"><i class="fa fa-circle-o"></i> Year Level</a></li>
                  <li><a href="department.php?yr='.$yr.'"><i class="fa fa-circle-o"></i> Department</a></li>
                  <li><a href="teacher.php?yr='.$yr.'"><i class="fa fa-circle-o"></i> Teacher</a></li>
                  <li class=""><a href="section.php?yr='.$yr.'"><i class="fa fa-circle-o"></i> Class</a>
                  </li>';
                  ?>
                </ul>
              </li>
          ...
          <ul class="sidebar-submenu" style="display: none;">
            ...
            foreach ($sy as $key) {
              if($key['status']=='inactive'){
                echo '<li><a href="year_level.php?yr='.$key['sy_id'].'"><i class="fa fa-circle-o"></i> S.Y. '.$key['year'].'</a></li>';
              }
            }
            ?>
          </ul>
...
<div class="container">
  ...
  <?php
  if($grade==7) 
    echo '<li class="active"><a data-toggle="tab" onclick="sec7(this.value)" href="#home">Grade 7</a></li>';
  else
    echo '<li><a data-toggle="tab" onclick="sec7(this.value)" href="#home">Grade 7</a></li>';
  if($grade==8)
    echo '<li class="active"><a data-toggle="tab" onclick="sec8(this.value)" href="#menu1">Grade 8</a></li>';
  else
    echo '<li><a data-toggle="tab" onclick="sec8(this.value)" href="#menu1">Grade 8</a></li>';
  if($grade==9)
    echo '<li class="active"><a data-toggle="tab" onclick="sec9(this.value)" href="#menu2">Grade 9</a></li>';
  else
    echo '<li><a data-toggle="tab" onclick="sec9(this.value)" href="#menu2">Grade 9</a></li>';
  if($grade==10)
    echo '<li class="active"><a data-toggle="tab" onclick="sec10(this.value)" href="#menu3">Grade 10</a></li>';
  else
    echo '<li><a data-toggle="tab" onclick="sec10(this.value)" href="#menu3">Grade 10</a></li>';
  ?>
  </ul>
...
?>
  <div class="container">
	<div class="input-column" style="width:200px;margin-left:-15px;"><br>
      <select class="form-control" onchange="g7(this.value)">
      <?php
...
<?php
        $print=null;
		$query = mysqli_query($conn, "SELECT ROOM_NO FROM css_section, css_room, css_school_yr 
												WHERE css_section.ROOM_ID=css_room.ROOM_ID AND css_section.SY_ID=css_school_yr.SY_ID 
        ...
        $sec = mysqli_query($conn, "SELECT P_lname, P_fname 
                                    ...
                                    AND SECTION_ID = $s_id[0]");
        foreach ($sec as $adv) {
          $adv_name[] = $adv['P_fname']." ".$adv['P_lname'];
        }
	...
	<table style="width:100%"><br>
                        <thead>
                          <tr class="headings">
                            ...
                            <td width="100px" class="column-title" style="text-align:center"><p style="font-size:25px;"><?php echo $grade." - ".$s[0]?></p>ROOM <?php echo $r[0]?></td>
                          </tr>
                        </thead>
              ...
              <tr>
               ...
               <td class="" height="70px"><?php echo $adv_name[0] ?></td>
              </tr>
                        </tbody>
                      </table>
      </div>
...
?>
  <div class="container">
	<div class="input-column" style="width:200px;margin-left:-15px;"><br>
      <select class="form-control" onchange="g8(this.value)">
      <?php
        foreach ($section as $key) {
          $s[] = $key['SECTION_NAME'];
...
?>
  <div class="container">
	<div class="input-column" style="width:200px;margin-left:-15px;"><br>
      <select class="form-control" onchange="g9(this.value)">
      <?php
        foreach ($section as $key) {
          $s[] = $key['SECTION_NAME'];
...
?>
  <div class="container">
	<div class="input-column" style="width:200px;margin-left:-15px;"><br>
      <select class="form-control" onchange="g10(this.value)">
      <?php
        foreach ($section as $key) {
          $s[] = $key['SECTION_NAME'];
