    ...
    <div class="modal-content" style="background-color:#fff;">
      ...
      <div> 
           <br>
            ...
            <form class="form-horizontal custom-form" action="delete_process.php" method="POST">
                      ...
                      <div>
                        ...
                        <div class="col-sm-4 label-column">
                          ...
                          <div class="col-sm-5 input-column" style="text-align:right">
                        		<select class="form-control" name = "sec" id = "" onchange="del_sub(this.value)" required="">
...
<script type="text/javascript">
	function del_sub(val){
		$.ajax({
			type: "POST",
			url: "delete_sched_sub.php",
			data: "sec_id="+val,
