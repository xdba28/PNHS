    ...
    <nav class="navbar-inverse navbar-fixed-top navigation-side" id="sidebar-wrapper" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="modules/prs/AdminB/employee.php"><i class="fa fa-fw fa-circle-o"></i>Employee Masterlist</a>
        ...
        <li>
            ...
            <?php                    
                ...
                <li>
                    <a href="modules/scms/pages/stuper/consult_hist.php"><i class="fa fa-fw fa-history"></i> Medical History</a>
                </li> 
            <?php                
                    }
                ?>
        ...
        <li>
            ...
            ?>
                ...
                <li>
                    <a href="modules/SIS/student/stu_drp_dwn.php"><i class="fa fa-fw fa-chain"></i>Assign Section</a>
                </li>
                <li>
