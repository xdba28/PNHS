...
<?php 
    ...
    $checkmtrmonth = mysqli_query($conn,"SELECT * FROM `prs_mtr` WHERE month(time_issued)= month(now()) and year(time_issued) =year(now())");
                                    ...
                                    <a id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="#">
                                        ...
                                        <?php 
                                            ...
                                            if(strstr($job_title,"SUO")){                                                                          
                                                ...
                                                $prsqla=mysqli_query($conn,"SELECT pr_no FROM pms_pr WHERE pr_status='Approved' ");
                                                $prnuma=mysqli_num_rows($prsqla);
                                                if ($prnuma > 0) {
                                                    $notif+=$prnuma;
                                                }
                                                
                                                $prsqld=mysqli_query($conn,"SELECT pr_no FROM pms_pr WHERE pr_status='Denied' 
                                                ");
                                                ...
                                                $posqla=mysqli_query($conn,"SELECT po_no FROM pms_po WHERE po_status='Approved' 
                                                ");
                                                ...
                                                $posqld=mysqli_query($conn,"SELECT po_no FROM pms_po WHERE po_status='Denied' 
                                                ");
                                                ...
                                                $prsql=mysqli_query($conn,"SELECT pr_date,pr_no FROM pms_pr WHERE pr_status='Pending' ");
                                                $prnum=mysqli_num_rows($prsql);
                                                if ($prnum > 0) {
                                                    $notif+=$prnum;
                                                }
                                                
                                                $posql=mysqli_query($conn,"SELECT po_date,po_no FROM pms_po WHERE po_status='Pending'");
                                            ...
                                            if(strstr($job_title,"HTEACH")){                                                                          
                                                $nsql=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name FROM ipcrms_content,pims_personnel WHERE pims_personnel.emp_no=ipcrms_content.emp_No AND status='Pending' ");
