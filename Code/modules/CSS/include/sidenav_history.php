...
<nav class="navbar navbar-inverse navbar-fixed-top navigation-side" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar scrollbar sidebar-nav" id="style-4">
        ...
        <li>
                ...
                <ul class="nav collapse dropdown-submenu" id="subsubmenu13" role="menu">
                    <?php
                        if(!empty($_SESSION['sy'])){
                          echo'
                          <li><a data-toggle="tooltip" data-placement="right" title="Creates a new school year" href="../../../css/admin/year_level.php" onclick="modalFunction(this.value)"><i class="fa fa-circle-o"></i> Create</a></li>';
                        }else{
                          echo'
                          <li><a href="../../../css/admin/year_level.php?m=1" onclick="modalFunction(this.value)"><i class="fa fa-circle-o"></i> Create</a></li>';
                        }
                    ?>
            ...
            <ul>
                <ul class="nav collapse dropdown-submenu" id="subsubmenu14" role="menu">
				  <?php echo'
				  <li><a href="year_level.php?yr='.$yr.'" title="View schedules per year level for S.Y. '.$yr_title[0].'"><i class="fa fa-circle-o"></i> Year Level</a></li>
				  <li><a href="department.php?yr='.$yr.'" title="View schedules per department for S.Y. '.$yr_title[0].'"><i class="fa fa-circle-o"></i> Department</a></li>
				  ';
				  ?>
                </ul>
            </ul>
        ...
        <!-- DMS -->
        <?php 
            if($dms_priv=="1" || $user_type=="superadmin"){ ?>
    <li>
        ...
        <?php
                if($user_type=="admin" || $user_type=="superadmin"){
                    if(strstr($job_title,"HRM") || strstr($job_title,"ICTD") || $user_type=="superadmin"){
        ?>      
            <li>
        ...
        <li>
            ...
            <?php
                    ...
                    if($job_title=="SP1" || $job_title=="SP2" || $job_title=="SP3" || $user_type=="superadmin"){ ?>
        <li>
        ...
        <!-- PIMS -->
            <?php 
                if($pims_priv=="1" || $user_type=="superadmin"){ ?>
            ...
            <?php 
                ...
                <li>
                    ...
                    <?php
                        ...
                        if(strstr($job_title,"SECSP") || $user_type=="superadmin"){ ?>
                    <li>
        ...
        <!-- IMS -->
            <?php 
                if($ims_priv=="1" || $user_type=="superadmin"){ ?>
        ...
        <!-- PMS -->
            <?php 
                if($pms_priv=="1" || $user_type=="superadmin"){ ?>
        <li>
            ...
            <?php 
                ...
                <li>
                    ...
                    <ul class="nav collapse dropdown-menu" role="menu" id="submenu8">
                        ...
                        <?php
                        $query_lastmonth=mysqli_query($conn,"SELECT * FROM prs_report where month(date_issued) = month(now()) and year(date_issued)= year(now())");
                        ...
                        <?php }
                         $query_lastmonth=mysqli_query($conn,"SELECT * FROM prs_report where month(time_report_sign) = month(now()) and report_sign='LastMonthSign' and year(time_report_sign)= year(now())");
                         $know_if_available= mysqli_num_rows($query_lastmonth);
                        if($know_if_available > 0){
                    ?>	
                        <li>
        ...
        <?php
         ...
         <!-- SCMS -->
            <?php 
                if($scms_priv=="1" || $user_type=="superadmin"){ ?>
        <li>
            ...
            <?php
                    if($user_type=="admin" || $user_type=="superadmin"){
                        if(strstr($job_title,"NURS") || $user_type=="superadmin"){ ?>    
                <li>
            ...
            <?php    
                        }else if($emp_type=="Teaching" || $user_type=="superadmin"){
                            if($dept=="7" || $user_type=="superadmin"){ ?>   
                <li>
            ...
            <?php                    
                ...
                <li>
                    <a href="../../../scms/pages/stuper/consult_history.php">Medical History</a>
                </li>
            <?php
                            }
         ...
         <!-- SIS -->
            <?php 
                if($sis_priv=="1" || $user_type=="superadmin"){ ?>
        <li>
            ...
            <?php 
                    ...
                    }else if(strstr($job_title,"RK") || $user_type=="superadmin"){ ?>   
            <li>
