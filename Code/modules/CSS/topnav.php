...
<?php 
    ...
    if(isset($_SESSION['user_data'])){
        if(isset($_SESSION['user_data']['acct']['lrn'])){
            ...
            $aid=$_SESSION['user_data']['acct']['cms_account_ID'];
            $rec=mysqli_query($conn,"SELECT dms_receiver.rec_no FROM dms_receiver,cms_account WHERE cms_account.cms_account_id=dms_receiver.cms_account_id AND dms_receiver.cms_account_id=$aid");
            $recrow=mysqli_fetch_assoc($rec);
            $recid=$recrow['rec_no'];
            $sql_dept=mysqli_query($conn,"SELECT pims_employment_records.dept_id FROM pims_personnel,pims_employment_records,pims_department WHERE pims_employment_records.emp_no=pims_personnel.emp_no
        ...
        if($_SESSION['user_data']['priv']['prs_priv']=="1" || $_SESSION['user_data']['priv']['prs2_priv']=="1"){
            $queryreport = mysqli_query($conn,"SELECT * FROM prs_report WHERE month(date_issued) = '$prevmonth' AND year(date_issued) = '$prevyear'" );
            $checkreport = mysqli_num_rows($queryreport);

            $checkmtrmonth = mysqli_query($conn,"SELECT * FROM `prs_dtr_rec` WHERE month(date_import)= month(now()) and year(date_import) =year(now())");
            $checkmtrrow = mysqli_num_rows($checkmtrmonth);


             $queryempselect= mysqli_query($conn," SELECT * FROM pims_personnel, pims_employment_records 
            Where pims_personnel.emp_No=pims_employment_records.emp_No");
             $checksalrec= '';
             $checkaddinfoget= '';

            $checkempno= mysqli_query($conn,"SELECT emp_No
                                                FROM pims_personnel 
                                                WHERE emp_No NOT IN
                                            (SELECT emp_No FROM prs_salary_record)");
            $rowcheckempno = mysqli_num_rows($checkempno);

            $checkempadd= mysqli_query($conn,"SELECT emp_No
                                                FROM pims_personnel 
                                                WHERE emp_No NOT IN
    ...
    ?>
<nav class="navbar navbar-fixed-top w3-card-4 navigation-top">
                <div class="container-full">
                        ...
                        <div class="row"> 
                            <div class="col-md-2">
                                <div class="navbar-header">
                                    ...
                                    <a href="../../../index.php"><img style="width:210px;" src="../../../docs/img/pnhs_logo_3.png"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-offset-0 col-md-11 col-md-offset-1">
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                        ...
                                        $scms=$conn->query("SELECT pims_employment_records.dept_id 
                                    ...
                                    <a role="button" data-toggle="dropdown" href="#" class="notif">
                                        ...
                                        <?php 
                                            ...
                                            if(strstr($job_title,"SUO")){                                                                          
                                                ...
                                                $risqla=mysqli_query($conn,"SELECT ris_no,concat(p_fname,' ',p_lname) as Name FROM pims_personnel,pms_ris WHERE req_status='Approved'
                                                AND ris_sp_seen='0'
                                                ...
                                                $risqld=mysqli_query($conn,"SELECT ris_no,concat(p_fname,' ',p_lname) as Name FROM pims_personnel,pms_ris WHERE req_status='Denied'
                                                AND ris_sp_seen='0'
                                                AND pms_ris.emp_no=pims_personnel.emp_no");
                                                ...
                                                $prsqla=mysqli_query($conn,"SELECT pr_no FROM pms_pr WHERE pr_status='Approved' AND pr_seen='0'");
                                                $prnuma=mysqli_num_rows($prsqla);
                                                if ($prnuma > 0) {
                                                    $notif+=$prnuma;
                                                }
                                                
                                                $prsqld=mysqli_query($conn,"SELECT pr_no FROM pms_pr WHERE pr_status='Denied' AND pr_seen='0' 
                                                ");
                                                ...
                                                $posqla=mysqli_query($conn,"SELECT po_no FROM pms_po WHERE po_status='Approved' AND po_seen='0' 
                                                ");
                                                ...
                                                $posqld=mysqli_query($conn,"SELECT po_no FROM pms_po WHERE po_status='Denied' AND po_seen='0'
                                                ");
                                                ...
                                                $risql=mysqli_query($conn,"SELECT req_date,ris_no,concat(p_fname,' ',p_lname) as Name FROM pims_personnel,pms_ris WHERE req_status='Pending'
                                                AND ris_admin_seen='0'
                                                AND pms_ris.emp_no=pims_personnel.emp_no");
                                                ...
                                                $prsql=mysqli_query($conn,"SELECT pr_date,pr_no FROM pms_pr WHERE pr_status='Pending' AND pr_sp_seen='0'");
                                                $prnum=mysqli_num_rows($prsql);
                                                if ($prnum > 0) {
                                                    $notif+=$prnum;
                                                }
                                                
                                                $posql=mysqli_query($conn,"SELECT po_date,po_no FROM pms_po WHERE po_status='Pending' AND po_sp_seen='0'");
                                                $ponum=mysqli_num_rows($posql);
                                                if ($ponum > 0) {
                                                    $notif+=$ponum;
                                                }
                                            }else{
                                                $risqla=mysqli_query($conn,"SELECT pms_ris.ris_no FROM pms_ris,pims_personnel 
                                                ...
                                                $risqld=mysqli_query($conn,"SELECT pms_ris.ris_no FROM pms_ris,pims_personnel 
                                            ...
                                            if(strstr($job_title,"HTEACH")){                                                                          
													...
													$nsql=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name FROM ipcrms_content,pims_personnel,pims_employment_records,pims_department 
                                                ...
                                                $nsql=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name FROM ipcrms_content,pims_personnel WHERE pims_personnel.emp_no=ipcrms_content.emp_No AND status='Verified' ");
                                                $ntsql=mysqli_num_rows($nsql);
                                                if ($ntsql > 0) {
                                                    $notif+=$ntsql;
                                                }
                                            }else if(strstr($job_title,"TCH") || strstr($job_title,"MTCHR")){
                                                $nsql=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name FROM ipcrms_content,pims_personnel WHERE pims_personnel.emp_no=ipcrms_content.emp_No AND status='Approved' and pims_personnel.emp_no=$emp");
                                                $ntsql=mysqli_num_rows($nsql);
                                                if ($ntsql > 0) {
                                                    $notif+=$ntsql;
                                                }      
...
<!--                                    <h4 class="menu-title pull-right">View all<i class="glyphicon glyphicon-circle-arrow-right"></i></h4>-->
                                    ...
                                    <div class="notifications-wrapper">
                                       <?php 
                                        ...
                                        <a class="content" href="#">
                                            ...
                                            if($recid!=""){
                                                if($inboxrow['count(dms_message.mes_id)']>=1){
                                                    $mes=mysqli_query($conn,"SELECT concat(p_fname,' ',p_lname) as Name,dms_message.mes_id,mes_title,sent FROM dms_message,dms_receiver,cms_account,pims_personnel 
                                                    WHERE dms_receiver.rec_no=dms_message.rec_no
                                                    AND pims_personnel.emp_no=cms_account.emp_no
                                                    AND dms_message.cms_account_id=cms_account.cms_account_id
                                                    AND dms_receiver.rec_no=$recid
                                            ...
                                            if(strstr($job_title,"HTEACH")){   
                                                if($ntsql>0){
                                                    $notif=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name,ipcrms_content.emp_No FROM ipcrms_content,pims_personnel, pims_employment_records WHERE pims_personnel.emp_no=ipcrms_content.emp_No AND status='Pending' AND dept_ID='$dept' and pims_personnel.emp_No = pims_employment_records.emp_No");
                                        ...
                                        <?php	
                                                ...
                                                if($ntsql>0){
                                                    $notif=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name,ipcrms_content.emp_No FROM ipcrms_content,pims_personnel WHERE pims_personnel.emp_no=ipcrms_content.emp_No AND status='Verified'");
                                                    while($norow=mysqli_fetch_assoc($notif)){ ?>
                                        ...
                                        <?php	
                                                ...
                                                if($ntsql>0){
                                                $notif=mysqli_query($conn,"SELECT distinct concat(p_fname,' ',p_lname) as Name,ipcrms_content.emp_No FROM ipcrms_content,pims_personnel WHERE pims_personnel.emp_no=ipcrms_content.emp_No AND status='Approved' and pims_personnel.emp_no=$emp");
								                while($norow=mysqli_fetch_assoc($notif)){ ?>
                                        ...
                                        <?php          
                                            ...
                                            <a class="content" href="../../IPMS/PMS/admin/ris_page.php?seen=1">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="../../IPMS/PMS/admin/pr.php?seen=1">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="../../IPMS/PMS/admin/po.php?seen=1">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                            ...
                                            <a class="content" href="../../../IPMS/PMS/USER/view.php?ris_no=<?php echo $risra['ris_no']; ?>">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                             ...
                                             <a class="content" href="../../../IPMS/PMS/USER/view.php?ris_no=<?php echo $risrd['ris_no']; ?>">
                                                <div class="notification-item">
                                                    <h4 class="item-title">
                                                    </h4>
                                ...
                                <li>
                                    <a href="section.php" >My Schedule</a>
                                </li>      
                                        <?php        
                                            } 
                                        if($_SESSION['user_data']['priv']['oes_priv']=="1"){ ?>
                                <li>
                                    <a href="modules/OES/my_subjects.php"> My Subjects</a>
                                        ...
                                        if($_SESSION['user_data']['priv']['scms_priv']=="1"){ ?>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        Health Monitoring
                                        <span class="caret"></span>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <?php 
                                        $empname=mysqli_query($conn,"SELECT concat(p_fname,' ',p_lname)as Name FROM pims_personnel WHERE emp_no=$emp");
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        $empname=mysqli_query($conn,"SELECT concat(stu_fname,' ',stu_lname)as Name FROM sis_student WHERE lrn=$sesh_lrn");
                                        $emprow=mysqli_fetch_assoc($empname);
                                        echo $emprow['Name']." ";
                                        ?>
                                        <span class="caret"></span>
