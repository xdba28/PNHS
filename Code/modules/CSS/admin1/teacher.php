            ...
            <div id="main" class="container-fluid">
				<div class="tab-content" style="margin-left:145px">
					...
					<table style="width:92%"><br>
						...
						<tbody style="text-align:center; font-size:17px; font-family:times">
							<?php 
								for ($i=0; $i < count($times); $i++) { 
									if(empty($print1[$i])){
										$print1[$i]="";
								...
								for ($i=0; $i < count($times); $i++) { 
									if($i%2 == 0) {
										echo'
										<tr>
										<td class="" width="30%" style="color:#ffff;background-color:#153948"><b>'.substr($time[$i], 0, -3).'-'.substr($time[$i+1], 0, -3).'</b></td>
							...
							?>
						<tr>
							<td class="" width="30%" style="color:#ffff;background-color:#153948"><b>TOTAL LOADS</b></td>
