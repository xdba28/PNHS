                    ...
                    <br>
                      <div>
                        <div class="form-group" style="text-align:right">
                          ...
                          <br>
                          <center>
                            <button class="btn btn-primary save fa fa-check"  type="submit"> OK
                            </button>
                          </center>
                        </div>
                      </div>
...
?>
								  ...
								  <div class="form-group">
									  ...
									  <div class="col-md-10 col-md-offset-1">
										<br>
										  <div>
											<div class="form-group" style="text-align:right">
											  <p style="text-align: center;">save na talaga?</p>
											  <br>
					...
					$row = mysqli_fetch_row($query);
					if(mysqli_num_rows($query)!=0){
					  echo 'Schedule for Academic Year (S.Y. '.$row[0].')';
					}
					else{
							...
							<div class="pane-vScroll">
							  <table>
												...
												<?php
												  ...
												  $x = 0;
												  $query = mysqli_query($conn, "LOCK TABLES css_section, pims_personnel, pims_employment_records READ");
