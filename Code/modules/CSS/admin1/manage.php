					  ...
					  ?>
							  ...
							  <tr>
								...
								<div class="col-md-6">
								  ...
								  <button class="btn save_manage" type="submit" name="btn" value="<?php echo $s_y['sy_id']?>">Update</button>
								  </form>
								  <a href="edit_sched.php?yr=<?php echo $s_y['sy_id']?>" class="btn save_manage">Edit</a>
								  <button class="btn save_manage" value="<?php echo $s_y['sy_id']?>" onclick="del_m(this.value)">Delete</button>
								</td>
							  </tr>
							</table>
					  <?php 
