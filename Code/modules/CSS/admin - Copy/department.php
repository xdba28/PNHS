...
$query = mysqli_query($conn, "LOCK TABLES css_school_yr READ");
...
if(!empty($tio)){
  $_SESSION['sy_id'] = $tio;
  $year_title_query = mysqli_query($conn, "SELECT year FROM css_school_yr WHERE sy_id = $tio");
                ...
                <div class="container" style="min-height:800px">
					...
					<div class="container">
					  <div class="dropdown" style="margin-left:-19px">
						...
						<div style="overflow-y:scroll; height:150px; width:170px" class="dropdown-content"> 
						  <a href="department.php?gradelvl=7">Grade 7</a>
						  <a href="department.php?gradelvl=8">Grade 8</a>
						  <a href="department.php?gradelvl=9">Grade 9</a>  
						  <a href="department.php?gradelvl=10">Grade 10</a>
						</div> 
					  </div>
					</div>
					<br> 
					...
					<!-- MODALS PRINT BUTTON -->   
					  <div id="button_bars">
						...
						<button class="a btn btn-sm  create" style="margin-top:5px">
						  ...
						  <table id="table2"><br>
							<thead>
							  ...
							  <tr>
								...
								<tbody style="text-align: center; font-size: 15px">
								   <?php 
								   $query = mysqli_query($conn, "LOCK TABLES pims_personnel, pims_employment_records, css_section, css_school_yr, css_schedule READ");
								   $eng = mysqli_query($conn, "SELECT * FROM pims_personnel, pims_employment_records
															  WHERE pims_personnel.emp_No=pims_employment_records.emp_No
															  AND dept_ID=3");
								   foreach ($eng as $key) {
						  ...
						  <table id="table3"><br>
							<thead>
							  ...
							  <tr>
								...
								<tbody style="text-align: center; font-size: 15px">
								   <?php 
								   $query = mysqli_query($conn, "LOCK TABLES pims_employment_records, pims_personnel, css_section, css_school_yr, css_schedule READ");
								   $eng = mysqli_query($conn, "SELECT * FROM pims_personnel, pims_employment_records
															  WHERE pims_personnel.emp_No=pims_employment_records.emp_No
															  AND dept_ID=1");
								   foreach ($eng as $key) {
