                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">  
                            ...
                            <ul class="nav nav-third-level">
                                <?php
                                    if (empty($_SESSION['modal'])) {
                                      ...
                                      echo'
                                      <li><a data-toggle="tooltip" data-placement="right"href="../../../css/admin/index.php" title="Creates a new school year" onclick="modal_dont_show(this.value)"><i class="fa fa-circle-o"></i> Create</a></li>';
                                    }
                                ?>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li><a data-toggle="tooltip" data-placement="right" title="View schedules per year level"  href="../../../css/admin/history/year_level.php?yr=<?php echo $yr?>"><i class="fa fa-circle-o" onclick="modal_dont_show(this.value)"></i> Year Level</a></li>
                                <li><a data-toggle="tooltip" data-placement="right" title="View schedules per department" href="../../../css/admin/history/department.php?yr=<?php echo $yr?>""><i class="fa fa-circle-o"></i> Department</a></li>
                            </ul>
                        </li>
                        <li>
                                        ...
                                        <?php
                                            ...
                                            foreach ($sy as $key) {
                                                if($key['status']=='active'){
                                                    echo ' <li><a data-toggle="tooltip" data-placement="right" href="../../../css/admin/year_level.php" title="View schedule for S.Y. '.$key['year'].'."><i class="fa fa-circle-o"></i>'; 
                        ...
                        <li>
                            ...
                            <ul class="nav nav-third-level">
								...
								<li><a data-toggle="tooltip" data-placement="right" title="Manage time" href="../../../css/admin/time.php"><i class="fa fa-circle-o"></i> Time</a></li>
            ...
            <li>
                ...
                <li>
                    <a href="../../../ipms/pms/admin/delivery.php"><i class="fa fa-fw fa-dropbox"></i>Delivery</a>
                        <ul class="nav nav-third-level">
                        <li><a href="../../../ipms/pms/admin/delivery.php"><i class="fa fa-fw fa-circle-o"></i>Complete</a></li>
                        <li><a href="../../../ipms/pms/admin/partial_del.php"><i class="fa fa-fw fa-circle-o"></i>Partial</a></li>
                    </ul>
                </li> 
