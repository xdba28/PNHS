...
<?php 
	$w = $_POST['width'];
	$_SESSION['wid'] = $w;
	$_SESSION['first_width'] = 1;

if (!isset($w)) {
	
echo '<form action="index2.php?width='.$w.'" method="POST"  id="window_width_form">';
 } 
echo '<input name="width" id="window_width" value="" / hidden></input>';
 ?>
<script>
 $(function(){    
