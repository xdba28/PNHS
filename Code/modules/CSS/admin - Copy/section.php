	...
	<?php include("../topnav.php"); ?>
        <div id="wrapper" style = "height:100%">
			...
			<?php 	if (mysqli_num_rows($query) != 0) { ?>
						<center>
							<h2 style="padding-bottom:10px;padding-top:50px;margin-left:400px"> Schedule of <?php
							...
							<?php if($adv_sec != NULL) {
								echo '
									<h4 style="margin-left:400px;font-family:times;font-size:25px"><b>'.$adv_sec.'</b></h4>
									<h6 style="margin-left:400px;font-size:19px"><i>'.$room.'</i></h6>
									<p style="margin-left:400px">(Adviser)</p>
								';
							} else {
								echo '
									<h4 style="margin-left:400px;font-family:times;font-size:25px"><b>No Adviser</b></h4>
								';
							}								
							?>
						</center>
            ...
            <div id="main" class="container-fluid">
				<div class="tab-content" style="margin-left:400px">
