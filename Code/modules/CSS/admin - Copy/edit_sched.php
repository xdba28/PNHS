                ...
                <div class="container">
					...
					<!-- Modals button -->   
                          ...
                          <center><h2 style="padding-bottom: 10px;"> Schedule for Academic Year <?php
                            $query = mysqli_query($conn, "SELECT year FROM css_school_yr WHERE css_school_yr.SY_ID=$yr_id ");
                       ...
                       <!-- Selecting sections (start) -->
						...
						<!--- TABLES START -->
						  ...
						  if($grade==8)
							echo '<li class="active"><a data-toggle="tab" onclick="grade8(this.value)" href="#menu1">Grade 8</a></li>';
						  else
