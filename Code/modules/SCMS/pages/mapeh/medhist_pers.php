				...
				<?php
					...
					while($medr = mysqli_fetch_array($fetch_medr))
					{
						...
						$m = mysqli_fetch_array($fetch_m);
                                    ...
                                    $xeyed = strtoupper($m['eye_cond_desc']);
                    ...
                    <div class="panel panel-primary">
						...
						mysqli_query($mysqli, "LOCK TABLES cms_account, scms_medrec READ");
							...
							$medrec = mysqli_fetch_array($fetch_medrec);
                                    $eye = strtoupper($medrec['eyeglass']);
                                    $ear = strtoupper($medrec['ear_infection']);
                                    $eyed = strtoupper($medrec['eye_cond_desc']);
                                    $eard = strtoupper($medrec['ear_cond_desc']);
