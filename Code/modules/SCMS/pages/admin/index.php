	...
	window.onload = function () {
		<?php
			...
			$sq="SELECT DATE_FORMAT(scms_consultation.cons_date, '%Y') AS Month, COUNT(scms_consultation.patient_id) AS Total FROM scms_consultation 
				WHERE (MONTH(scms_consultation.cons_date) IN (6,7,8,9,10,11,12) AND YEAR(scms_consultation.cons_date) = '".$uyrstart."') OR 
				(MONTH(scms_consultation.cons_date) IN (1,2,3,4,5) AND YEAR(scms_consultation.cons_date) = '".$uyrend."')
                    ...
                    <div class="panel panel-info">
						...
						<div class="panel-body">
						   <div class="container" style="margin:0;padding:0">						
								<div class="col-md-4" style=" padding-top:10px;padding-left:10px">
									...
									<div class="tab-content">
										<div id="tab1" class="tab-pane fade active in">
											<div id="chartContainer7" style="height: 250px; width: 90%;"></div>
										</div>
										<div id="tab2" class="tab-pane">
											<div id="chartContainer8" style="height: 250px; width: 90%;"></div>
										</div>
										<div id="tab3" class="tab-pane">
											<div id="chartContainer9" style="height: 250px; width: 90%;"></div>
										</div>
										<div id="tab4" class="tab-pane">
											<div id="chartContainer10" style="height: 250px; width: 90%;"></div>
										</div>
										<div id="tab5" class="tab-pane">
											<div id="chartContainer11" style="height: 250px; width: 90%;"></div>
										</div>
										<div id="tab6" class="tab-pane">
											<div id="chartContainer12" style="height: 250px; width: 90%;"></div>
										</div>			
									</div>
								</div>
							</div>
