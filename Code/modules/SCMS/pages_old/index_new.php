...
<script>
	...
	window.onload = function () {
		<?php
			mysqli_query($connect, "LOCK TABLES css_school_yr READ");
			
			$updateyear = mysqli_query($connect,"SELECT year from css_school_yr
			WHERE status = 'active'")
			...
			mysqli_query($connect, "LOCK TABLES scms_consultation, pims_personnel, sis_student, scms_bmi_rec, sis_student, cms_account, sis_stu_rec, css_section, css_school_yr READ");
...
<!--chart2-->		
	<?php
	 $fetch_yr = mysqli_query($connect, "SELECT * FROM css_school_yr
					 WHERE status = 'active'")
					 or die(mysqli_error($connect));
...
<body>
	 <?php include("../include/side_top_nav.php");  ?>
								...
								<div class="panel-heading">
									<div class="row">
										...
										<div class="col-xs-5 text-right">
											<div class="normal">
											<?php
											$fetch_daily_pat = mysqli_query($connect,"SELECT COUNT(patient_id) AS Total FROM `scms_consultation` WHERE cons_date = CURRENT_DATE");
								...
								<div class="panel-heading">
									<div class="row">
										...
										if ($z>=01 && $z<=07){
											...
											$fetch_weekly_pat = mysqli_query($connect, "SELECT COUNT(patient_id) AS Total
								...
								<div class="panel-heading">
									<div class="row">
										...
										if ($current_date=="01"){
											...
											$fetch_monthly_pat = mysqli_query($connect, "SELECT COUNT(patient_id) AS Total
												FROM scms_consultation 
								...
								<div class="panel-heading">
									<div class="row">
										...
										<div class="col-xs-5 text-right">
											<div class="normal">
											<?php
											$fetch_stud = mysqli_query($connect,"SELECT COUNT(sis_student.lrn) AS Total FROM sis_student");
								...
								<div class="panel-heading">
									<div class="row">
										...
										<div class="col-xs-5 text-right">
											<div class="normal">
											<?php
											$fetch_per = mysqli_query($connect,"SELECT COUNT(pims_personnel.emp_No) AS Total FROM pims_personnel");
			...
			<div class="col-lg-7">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="" id="chartContainer1" style="height:310px; width: 100%;">
							</div>				
                        <!-- /.panel-body -->
							</div>
			...
			<div class="col-lg-3">
                    <div class="panel panel-info">
						...
						<?php
							...
							$fetch_tp = mysqli_query($connect, "SELECT COUNT(patient_id)  AS Total, diagnosis  AS Diagnosis
							FROM scms_consultation
                            ...
                            <div >
                                <table class="table table-striped">
                                    <tbody>
										...
										$fetch_top = mysqli_query($connect, "SELECT COUNT(patient_id)  AS Total, diagnosis  AS Diagnosis
										FROM scms_consultation
			...
			<div class="col-lg-4">
                    <div class="panel panel-info">
						...
						<div class="col-xs-5" style="float:right">
							...
							<?php
							$fetch_sect = mysqli_query($connect, "SELECT year, SECTION_ID, CONCAT(css_section.YEAR_LEVEL,' - ',css_section.SECTION_NAME) AS YR_SEC FROM `css_section`, css_school_yr
							...
							</div><hr style = "padding-bottom: 0px; margin-bottom: 0px; border-color: silver;">
                        <!-- /.panel-heading -->
						<div id="txtHint" style = "margin-top: 0px; padding-top: 0px;">
                        
                                        	<?php
									$fetch_status = mysqli_query($connect, "SELECT scms_bmi_rec.nutri_status, 
   ...
   <div class="container">						
    <div class="col-md-4">
        <ul class="nav nav-pills nav-jt">
            <li class="active"><a data-toggle="tab" href="#tab1"><small>G.7</small></a></li>
            <li><a data-toggle="tab" id= "bs-tab2" href="#tab2"><small>G.8</small></a></li>
            <li><a data-toggle="tab" id= "bs-tab3" href="#tab3"><small>G.9</small></a></li>
            <li><a data-toggle="tab" id= "bs-tab4" href="#tab4"><small>G.10</small></a></li>
            <li><a data-toggle="tab" id= "bs-tab5" href="#tab5"><small>G.11</small></a></li>
            <li><a data-toggle="tab" id= "bs-tab6" href="#tab6"><small>G.12</small></a></li>			
        </ul><hr>
