...
$pdf->Ln();
        ...
        $pdf->Cell(50.1,7,"{$n}",1,0,'C',true);
	    $pdf->Cell(20,7,"{$all['sis_b_day']}",1,0,'C',true);
	    $pdf->Cell(17,7,"{$all['weight']}",1,0,'C',true);
	    $pdf->Cell(17,7,"{$h}",1,0,'C',true);
	    $pdf->Cell(10.7,7,"{$all['sis_gender']}",1,0,'C',true);
	    $pdf->Cell(10,7,"{$age}",1,0,'C',true);
        $pdf->Cell(26,7,"{$all['bmi']}",1,0,'C',true);
	    $pdf->Cell(40,7,"{$all['nutri_status']}",1,0,'C',true);
        $pdf->Ln();
        $countall++;
