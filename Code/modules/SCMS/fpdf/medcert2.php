...
$pdf->SetLineWidth(.3);
	...
	$pdf->Ln();
	$pdf->Cell(0,4,'PROOF OF CONSULTATION',0,0,'C',true);
	$pdf->Ln();
...
$pdf->Cell(0,3,"Date  {$c}",0,1,'R',true);
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
...
$pdf->MultiCell(200,7,"               This is to certify that {$n} of {$sec} was seen/examined and found to be suffering from {$diag}.",1,'L',false);
$pdf->MultiCell(200,7,"               In lieu of this, he/she is permitted to go home and is advised to return to school as soon as he/she
recovers.",1,'L',false);
}
$pdf->Ln();
$pdf->Ln();
