...
<body>
        ...
        <div id="wrapper">
			...
			<ol class="breadcrumb">
				...
				$fetch_section = mysqli_query($mysqli, "SELECT * FROM sis_stu_rec, css_school_yr, css_section, cms_account
				...
				<li><a onclick="goBack()">Grade '.$section['YEAR_LEVEL'].' - '.strtoupper($section['SECTION_NAME']).'</a></li>';
				}
				else if($studper['lrn'] == NULL){
					
				echo'<li><a href="personnel.php">Personnel Medical Records</a></li>';
				}
				?>
				...
				if($studper['emp_no'] == NULL){
					echo'
                    <h1 class="page-header">Profile <small><small>Student Profile and Medical Record</small></small>       
                    </h1>';
				}
				else if($studper['lrn'] == NULL){
					echo'
				...
				<?php
					...
					while($medr = mysqli_fetch_array($fetch_medr))
					{
						...
						$m = mysqli_fetch_array($fetch_m);
                                    ...
                                    $eyed = strtoupper($m['eye_cond_desc']);
                    ...
                    <div class="panel panel-primary">
						...
						<figure>
							...
							if(empty($u))
							{
								echo'<div align="center"><hr>
									...
									<!--<a href="create_medrec.php?id='.base64_url_encode($id).'">
						...
						mysqli_query($mysqli, "LOCK TABLES cms_account, scms_medrec READ");
							...
							$medrec = mysqli_fetch_array($fetch_medrec);
                                    ...
                                    $xeye = strtoupper($medrec['eyeglass']);
                                    $xear = strtoupper($medrec['ear_infection']);
                                    $xeyed = strtoupper($medrec['eye_cond_desc']);
                                    $xeard = strtoupper($medrec['ear_cond_desc']);
                        ...
                        <div class="panel-body">
							...
							<a href="update_medrec.php?id='.base64_url_encode($id).'">';
                                ...
                                echo '
                                    <a href="../../fpdf/medform.php?id='.base64_url_encode($id).'"><button type="button" style="float:right" class="btn btn-info btn-square btn-n" data-toggle="tooltip" data-placement="left" title="Print medical record">            
