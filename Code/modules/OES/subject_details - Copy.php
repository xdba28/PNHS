...
<body>
    ...
    <div class="student">
            ...
            <div class="header__right">
                ...
                <div class="link">
                    <a href="#" class="link4"><?php echo $teacher;?></a>
                </div>
            </div>
    </div>
...
<div class="det">
  ...
  <label for="tab1" class="tab">Subject Overview</label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="course_info">
                ...
                <ul>
                    <li>class instructor<span><?php echo $teacher;?></span></li>
					<li>Class Section<span><?php echo $section;?></span></li>
                    <li>class schedule<span><?php echo date("g:i a", strtotime($time_start)) . " - " . date("g:i a", strtotime($time_end));?></span></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div id="div-forms">
                    ...
                    <form id="login-form" class="attempt_exam"  action="student_exam.php" method="POST">
		                <div class="modal-body">
				    		...
				    		<input id="login_username" class="form-control pass_input" type="password" placeholder="Examination Password (type 'ERROR' for error effect)" required>
	...
	<script>function exam_no(exam_no){
	$('.pass_input').val('');
