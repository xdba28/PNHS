                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="exam.php?tab=1"><i class="fa fa-circle-o"></i>Create Exam</a>
                                    </li>
                                    <li>
                                        <a href="exam.php?tab=2"><i class="fa fa-circle-o"></i>Manage Exam</a>
                                    </li>
                                    <li>
                                        <a href="report.php?tab=6"><i class="fa fa-circle-o"></i>Exam Result</a>
                                    </li>
                                    <li>
                                        <a href="report.php?tab=7"><i class="fa fa-circle-o"></i>Result Chart</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="question.php?tab=4"><i class="fa fa-circle-o"></i>Create Question</a>
                                    </li>
                                    <li>
                                        <a href="question.php?tab=5"><i class="fa fa-circle-o"></i>Manage Questions</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
