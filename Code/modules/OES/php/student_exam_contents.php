<?php
//Get contents of exam for student examination
	if(isset($_POST['exam_no'])){
	try{
        require 'connect.php';
	$result_question = $mysqli->query("select bnk.*, ex_cont.points, ex_cont.content_no from oes_question_bank bnk, oes_exam_content ex_cont where bnk.question_no = ex_cont.question_no and ex_cont.exam_no = '$exam_no' LOCK IN SHARE MODE");
