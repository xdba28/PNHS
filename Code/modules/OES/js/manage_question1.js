          ...
          if (isConfirm) {            
			$.ajax({
				...
				$(".edit_question"+question_no).click( function(){
					...
					$('.question_body').empty();
					var ques_no = data[i].question_no;
					switch(question_type){
						...
						case 'Multiple Choice':
							...
							$('.question_body').append('<div class="outline-thread"><div class="title-thread"><div class="row"><div class="col-md-12"><div class="col-md-12 col-sm-12" style="margin-bottom: 1em;"><div class="form-inline"><div class="clearfx"><h4 class="thin h4a">Multiple Choice</h4><input type="text" name="edit_question_type" value="Multiple Choice" hidden /><input type="text" name = "edit_question_no" value="'+question_no+'" class="question_no" hidden /></div></div></div><div class="col-md-12 col-sm-12"><div class="form-group"><input type="text" class="form-control" placeholder="Question" name="edit_question" value="'+question+'"required /></div></div></div><div class="col-md-12"><div class="col-md-12 correct_group"><div class="col-md-6 col-sm-6"><div class="form-group"><input type="text" class="form-control" placeholder="Correct Answer" name="edit_mul_correct" value="'+correct_answer+'" required /></div></div><div class="correct_field"></div></div><div class="col-md-12 wrong-group"><div class="col-md-6 col-sm-6"><div class="form-group"><input type="text" class="form-control" placeholder="Wrong Answer" name="edit_mul_wrong[]" value="'+new_ans[0]+'"required /></div></div><div class="wrong_field"></div></div><div class="col-md-12 col-sm-12"><div class="clearfx" style="margin-bottom: 1em;"><div class="row"><div class="col s12 m6 l4"><div class="center"></div></div><div class="col s12 m6 l4"><div class="center"><button class="waves-effect waves-light btn edit_add_wrong">Add Wrong Answer</button></div></div><div class="col s12 m6 l4"><div class="center"><button class="edit_remove_button waves-effect waves-light btn red" title="Remove field">Remove Field</button></div></div></div></div></div></div></div></div></div>');
						...
						case 'Enumeration':
							...
							$('.question_body').append('<div class="outline-thread"><div class="title-thread"><div class="row"><div class="col-md-12"><div class="col-md-12 col-sm-12" style="margin-bottom: 1em;"><div class="form-inline"><div class="clearfx"><h4 class="thin h4a">Enumeration</h4><input type="text" name="edit_question_type" value="Enumeration"  hidden /><input type="text" name = "edit_question_no" value="'+question_no+'" class="question_no" hidden /></div></div></div><div class="col-md-12 col-sm-12"><div class="form-group"><input type="text" class="form-control" placeholder="Question" name="edit_question" value="'+question+'" required /></div></div></div><div class="col-md-12"><div class="col-md-12 answer_group"><div class="col-md-6 col-sm-6"><div class="form-group"><input type="text" class="form-control" placeholder="Answer" name="edit_enum_answer[]" value = "'+new_ans[0]+'"required /></div></div><div class="answer_field"></div></div><div class="col-md-12 col-sm-12"><div class="clearfx" style="margin-bottom: 1em;"><div><div class="col s12 m6 l6"><div class="left"><button class="waves-effect waves-light btn edit_add_answer">Add An Answer</button></div></div><div class="col s12 m6 l6"><div class="right"><button class="edit_remove_button waves-effect waves-light btn red" title="Remove field">Remove Field</button></div></div></div></div></div></div></div></div>');
							$('.edit_add_answer').parent().parent().parent().parent().parent().siblings('.answer_group').children('.answer_field').append(input);
							break;
					}
					
					
					$('.question_body').append('<div class="row button_top"><div class="col s12 m12 l4"><button class="outline modal_outline submit_btn" name="edit_save_btn" type="submit"><div class="add"><div class="name_title">Save Changes</div></div></button>     <button class="outline modal_outline" data-dismiss="modal"><div class="add add_red"><div class="name_title">Cancel</div></div></button> </div></div>');
