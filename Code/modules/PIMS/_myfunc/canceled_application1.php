<?php
	...
	$query = "select * from pims_leave , pims_leave_balance , pims_personnel where leave_application_status = 'User-Cancel' and pims_leave.leave_bal_id = pims_leave_balance.leave_bal_ID and pims_leave_balance.emp_No = pims_personnel.emp_No; ";
	...
	while( $row = mysqli_fetch_array($result) ){
		...
		$echo = $echo . " $('#tr".$count."').append($('<td>Canceled</td>')); ";
