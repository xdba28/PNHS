<?php
	...
	$query = "select * from pims_leave , pims_leave_balance , pims_personnel where leave_application_status = 'Approved' and pims_leave.leave_bal_id = pims_leave_balance.leave_bal_ID and pims_leave_balance.emp_No = pims_personnel.emp_No; ";
	$result = mysqli_query($_SESSION['pims_data']['connection'] , $query);
	
	$count = 1;
	
	while( $row = mysqli_fetch_array($result) ){
		$echo = $echo . " $('#tbody1').append($('<tr></tr>').attr({ 'class' : 'success' , 'id' : 'tr".$count."' })); ";
