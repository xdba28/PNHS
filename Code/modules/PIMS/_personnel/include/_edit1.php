            <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                                    ...
                                    <?php echo " <img id = 'image1' src='../myfunc/showimageprofile.php?id=".$_SESSION['pims_data']['emp_id']."' style='height: 257px; width: 242px;'> "; ?>
                                    </div>
                                    </div>

                                    <div class="col-lg-6">
                                    <label><br><br><br><br><br><span id = "spanpersonneltype" >TEACHINGG PERSONNEL</span></label>
                                    </div>
