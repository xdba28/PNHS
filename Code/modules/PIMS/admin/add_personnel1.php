...
<br><br><br><br>
    ...
    <div id="wrapper" style="margin-left: 350px;">
    ...
    <div  style="width: 500px;">
        ...
        <form id = "form1">
            ...
            <label>Password:</label><input type="password" name="password" placeholder="Password" class="form-control" /><br>

            <label>Retype Password:</label><input type="password" name="password" placeholder="Password" class="form-control" /><br>
