        ...
        <div class="container">
            <div class="col-lg-11"> 
                ...
                <div class="panel-heading">
                            <h3><img src="../img/disapproved2.png" style="width: 100px; height: 100px;"> &emsp;DISAPPROVED UPDATES</h3><br>
            ...
            <div class="col-lg-6" id="tab" style = "display: none" >
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br>
                        <a href="" id = "atab2"><button class="btn btn-outline btn-primary">Checked</button></a>&emsp;
...
<?php
	include("../myfunc/profile_updates_disapproved1.php");
?>
</body>
</html>