<?php
	...
	if ( !isset($_GET['id']) || empty($_GET['id']) ){
		header("Location: update_personnel1.php");
	}
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="panel-body">
                                ...
                                <div id="fambg">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input id = "dummy" name = "dummy" type = "text" class="form-control" placeholder="First Name - Middle Initial - Last Name" value="">
                                    </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <label>Date of Birth:</label>
                                        <input id = "dummy2" name = "dummy2" type = "date" class="form-control" placeholder="Enter Date" value="">
                                    </div>
        ...
        <div class="panel-body">
                                <div  id="edbg">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input id = "" name = "" class="form-control" placeholder="Enter School Name" value="">
                                        </div>
                                    </div>
                                    <div class = "col-lg-4">
                                    <div class="form-group">
                                            <label>Degree/Course:</label>
                                            <input id = "" name = "" class="form-control" placeholder="Enter Course" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label>From:</label>
                                            <input id = "" name = "" type="number" class="form-control" placeholder="Enter Year" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input id = "" name = "college2" class="form-control" placeholder="Enter School Name" value="">
                                        </div>
                                    </div>
                                    <div class = "col-lg-4">
                                    <div class="form-group">
                                            <label>Degree/Course:</label>
                                            <input id = "" name = "collegeDegree2" class="form-control" placeholder="Enter Course" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label>From:</label>
                                            <input id = "" name = "collegeFrom2" type="number" class="form-control" placeholder="Enter Year" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label>To:</label>
                                            <input id = "" name = "collegeTo2" type="number" class="form-control" placeholder="Enter Year" value="">
                                        </div>
                                    </div>
                                    <div class = "col-lg-4">
                                    <div class="form-group">
                                            <label>Honor or Award:</label>
                                            <input id = "" name = "honorAward2" class="form-control" placeholder="Enter Honor/Award" value="">
                                        </div>
                                    </div>
                                    <div class = "col-lg-4">
                                    <div class="form-group">
                                            <label>Higher Units Earned:</label>
                                            <input id = "" name = "honorAward2" class="form-control" placeholder="If Undergraduate" value="">
                                        </div>
                                    </div>
                                    <div class = "col-lg-4">
                                    <div class="form-group">
                                            <label>Affiliation:</label>
                                            <input id = "" name = "affiliation2" class="form-control" placeholder="Enter Affiliation" value="">
                                        </div>
                                    </div>                              
        ...
        <div class="panel-body">
                            <div id="">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type = "" name = "" id = "we_date_from1" class="form-control" placeholder="Enter" value="">
                                        </div>
                                    </div>
                                    <div class = "col-lg-2">
                                    <div class="form-group">
                                            <label>Rating:</label>
                                            <input type = "" name = "" id = "" class="form-control" placeholder="Enter Rating" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Date of Examination:</label>
                                            <input name = "" id = "" class="form-control" placeholder="Enter Date">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Place of Examination:</label>
                                            <input name = "" id = "" class="form-control" placeholder="Enter Place">
                                        </div>
                                    </div>
                                    <div class = "col-lg-2">
                                    <div class="form-group">
                                            <label>License Number:</label>
                                            <input type = "" name = "" id = "" class="form-control" placeholder="Enter Number" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
...
<div class="panel panel-default">
        ...
        <div class="panel-body">
                                <div id="trainings">
                                    ...
                                    <br><button type="reset" class="btn btn-outline btn-primary">Reset</button>
                                    &emsp;<?php echo ' <button id = "submitButton5" onclick = "submittrainingsattended('.$_SESSION['pims_data']['emp_id'].')"  type="button" class="btn btn-outline btn-primary">Submit</button> '; ?>
                                    </form>
                                </div>
...
<div class="panel panel-default">
        ...
        <div class="panel-body">
                                ...
                                <form id = "form6">
                                    ...
                                    <br><button type="reset" class="btn btn-outline btn-primary">Reset</button>
                                    &emsp;<?php echo ' <button id = "submitButton6" onclick = "submitemploymentrecord('.$_SESSION['pims_data']['emp_id'].')"  type="button" class="btn btn-outline btn-primary">Submit</button> '; ?>
                                </form>
                                </div>
</div>
</div>
...
<div class="panel panel-default">
        ...
        <div class="panel-body">
                                ...
                                <br><button type="reset" class="btn btn-outline btn-primary">Reset</button>
                                &emsp;<?php echo ' <button id = "submitButton7" onclick = "submitform7('.$_SESSION['pims_data']['emp_id'].')"  type="button" class="btn btn-outline btn-primary">Submit</button> '; ?>
                                </form>
                            </div>
                    ...
                    <center>
                    <button id = "submitButton8" type="button" onclick = "<?php echo "submitallforms(".$_SESSION['pims_data']['emp_id'].")"; ?>" class="btn btn-outline btn-primary btn-lg" >SUBMIT ALL</button>
                    </center>
                    <br><br>
</div>
</div>
...
<?php include 'include/footer.php';?>
    ...
    <script src = "../js/_update_personnel1.js"></script>
...
<!------- ALL PHP CUSTOMS HERE ONLY ------->
		<?php
			include("../myfunc/update_personnel1.php");
		?>
<!----------------------------------------->
</html>
