		...
		function verifyUniqueName( callback ){
						$.ajax({
	     					url: '../myfunc/add_personnel4.php',
							type: 'GET',
	...
	    				});
		...
		function verifyCompleteItemNo( callback ){
						$.ajax({
	     					url: '../myfunc/add_personnel5.php',
							type: 'GET',
	...
	    				});
		...
		function verifyBiometricsID( callback ){
						$.ajax({
	     					url: '../myfunc/add_personnel6.php',
							type: 'GET',
	...
	    				});
		...
		function submitForm1(){
			...
			// ---- NAME VERIFICATION ----
					...
					verifyUniqueName(function(test){
						if ( test == "true" ){
							resetAlertify();
			...
			if ($('#checkBoxSame2').is(':checked')){
				...
				verifyCompleteItemNo(function(test){
					if ( test == "true" ){
						resetAlertify();
			...
			if ( $('#divCode1').val() === "" ){
				...
				verifyBiometricsID(function(test){
					if ( test == "true" ){
						resetAlertify();
		...
		function submitForm1_2(var1,var2){
						...
						var formURL1 = "../myfunc/update_personnel2.php?";
						...
						{ 
							...
							alertify.confirm("You left the profile picture blank. This will make your picture null", function (e) {
								if (e) {
									resetAlertify();
