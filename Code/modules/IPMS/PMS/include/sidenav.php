        ...
        <div class="sidebar-nav navbar-collapse">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="../../../../modules/pims/personnel/emp_rec.php"><i class="fa fa-fw fa-circle-o"></i>Employment Records</a>
                    </li>
                    <li>
                        <a href="../../../../modules/pims/personnel/training.php"><i class="fa fa-fw fa-circle-o"></i>Training Programs</a>
                    </li>
                </ul>
            </li>
                <?php 
            ...
            <li>
                ...
                <li>
                    <a href="../../../../modules/ipms/pms/admin/partial_del.php"><i class="fa fa-fw fa-dropbox"></i>Partial Delivery</a>
                </li>
                <li>
                ...
                <li>
                    <a href="../../../../modules/ipms/pms/accountant/po_check_record.php"><i class="fa fa-fw fa-circle-o"></i>Transaction Records</a>
                </li>
                    <?php } ?>
                </ul>
            </li>        
