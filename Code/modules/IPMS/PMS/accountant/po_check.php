										...
										<table id="featured-datatable" class="table table-striped table-hover table-bordered">
											<?php
												  $sql = mysqli_query($mysqli, "SELECT * from pms_ris,pims_personnel, pms_pr, pms_pr_con, pms_ris_req, pms_po,     pms_po_con
                                                      ...
                                                      AND pms_po.payment_term = 'Check'
													  AND po_status = 'Approved1'");
										 ...
										 <?php  
											...
											<tr>
												...
												<td><center><a href="po_add_check.php?po=<?php echo $row['po_no']; ?>" class="bbtn btn-outline btn btn-success btn"><i class="fa fa-eye fa-sm"> View</i></button></center></td>
											<?php }
