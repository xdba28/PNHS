...
if(isset($_GET['ris_no'])){
  ...
  $update_ris_seen = mysqli_query($mysqli,"UPDATE pms_ris SET ris_seen = '1' WHERE ris_no = $id"); 
 ...
 <?php include("../include/sidenav.php"); ?>
  <div id="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
				<br>
                    <h3 class="page-header" style = "color:#337ab7; font-size: 30px; font-family:Georgia;"><center>STATUS RIS no. <?php echo $id?> </center></h3>	
		
		
<div class="col-lg-12">
						 		<div class="row">
								<div class="col-md-1"></div>
								<div class="col-md-1"><div class="col-md-1"><a href="trans.php" button type="button" class="bbtn btn-outline btn btn-primary btn"><i class="fa fa-reply fa-sm"> Back</i></button></a></div></div>
								<div class="col-md-1"></div>
								<div class="col-md-1"></div>
								<div class="col-md-1"></div>
								<div class="col-md-1"></div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="widget widget-task-progress clearfix">
								<div class="left">
									<center><b>Requisition</b></center><br>
									<div class="">
				...
				<?php while($kev = mysqli_fetch_array($ris)){ ?>
                                ...
                                <?php if ($kev['req_status']=='Finished'){ ?> <center><span class="percentage"> <img style="width:50px;" src="../docs/img/check.png"> </span></center><?php }?>
								<?php if ($kev['req_status']=='Pending'){ ?> <center><span class="percentage"> <img style="width:50px;" src="../docs/img/pending.png"> </span></center><?php }?>
						...
						<?php while($vin = mysqli_fetch_array($pr)){ ?>
                                ...
                                <?php if ($vin['pr_status']=='Finished'){ ?> <center><span class="percentage"> <img style="width:50px;" src="../docs/img/check.png"> </span></center><?php }?>
								<?php if ($vin['pr_status']=='Pending'){ ?> <center><span class="percentage"> <img style="width:50px;" src="../docs/img/pending.png"> </span></center><?php }?>
						...
						<?php while($hey = mysqli_fetch_array($po)){ ?>
                                ...
                                <?php if ($hey['po_status']=='Finished'){ ?> <center><span class="percentage"> <img style="width:50px;" src="../docs/img/check.png"> </span></center><?php }?>
								<?php if ($hey['po_status']=='Pending'){ ?> <center><span class="percentage"> <img style="width:50px;" src="../docs/img/pending.png"> </span></center><?php }?>
