  ...
  ?>
    <div id="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
				<br>
                <h3 class="page-header" style = "color:#337ab7; font-size: 30px; font-family:Georgia;"><center>RIS RECORDS</center></h3>	
				</div>
			</div>
            <br>
