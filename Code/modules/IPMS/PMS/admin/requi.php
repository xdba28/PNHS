						...
						<div class="box-body">
							<div class="row" style="margin-left: 20px">
								...
								<div class="col-xs-4">
									...
									<input type="text" style="text-align:center" class="form-control" id="dept_Name" value = "<?php echo "$dept" ?>"  name = "dept_Name"readonly>					
									</div>
								</div>
							...
							<?php 
                                            if(isset($_POST['btn'])){
                                                ...
                                                $ris=mysqli_query($mysqli,"INSERT INTO PMS_RIS(emp_no,req_date,req_status,remarks,ris_update_date,reason) VALUES($emp,'$date','Pending','Pending','&date','$reasons')");
                                                ...
                                                if($ris){
                                                    ...
                                                    if($er>=1){
														...
														echo "<script>alert('SUCCESS!'); window.location='trans.php?';</script>";
                                                    }
                                                }
