                  ...
                  <div id="page-wrapper">                  
                    ...
                    <div class="col-lg-12">
						...
						<form role="form"  method="post" action = "" id="">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                <div class="col-md-1"><div class="col-md-1"><a href="pr.php" button type="button" class="bbtn btn-outline btn btn-success btn"><i class="fa fa-reply fa-sm"> Back</i></button></a></div></div>
...
-->
                                        ...
                                        <tbody>				
                                            <tr id="0">
                                                <td><input type="text" id="sud" name="supp" class="awesomplete form-control" list="suppl" required>
                                                <datalist id="suppl">
                                                <?php
                                                            ...
                                                            <td>
                                                                <center>
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="est[<?php echo $row['pr_id'];?>]" id="est_<?php echo $x?>" onChange="cal(<?php echo $x; ?>)" class="form-control est" placeholder="Unit Cost" aria-describedby="basic-addon1" >
                                                                    </div>
                                                                </center>
                                                            </td>
                                                            <td>
                                                                <center>
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon" id="basic-addon1">&#8369;</span>
                                                                        <input type="text" name="tot[<?php echo $row['pr_id'];?>]" id="total_cost_<?php echo $x;?>" class="form-control tot" placeholder="Total Cost" aria-describedby="basic-addon1" >
                                                                    </div>
                                                                </center>
                                                            </td>
                                                        </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" disabled class="form-control" value="0"  id = "total_est" placeholder="     ----">
                                                        </div>
                                                    </center></td>
                                                    <td><center>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">&#8369;</span>
                                                            <input type="text" disabled id="total_unit_cost" value="0"  class="form-control" placeholder="     ----">
                                                        </div>
                                                    </center></td>
                                                </tr>
                                                </tbody>
                                            ...
                                            if(isset($_POST['go'])){
                                                ...
                                                if($poup){
                                                    for($i=0;$i<$ct;$i++){
                                                        ...
                                                        $update_ins_po = mysqli_query($mysqli, "UPDATE pms_pr_con SET ins_po = '1' WHERE pr_id = $item[$i]");
                                                        if($nris){
                                                            $ok+=1;
                                                        }else{
                                                            $er+=1;
					...
					<div class="modal-dialog">
						...
						<div class="modal-header">
							...
							<div class="modal-footer">
								...
								<button type="submit" class="btn btn-primary" name="submit1" id = "submit1" >Submit</button>
							</div>
...
<script>
    function cal($i)
    {
        ...
        var temp = document.getElementById('total_est').value;
        var ammt = (total1).toFixed(2);
        var temp1 = document.getElementById('total_unit_cost').value;
		document.getElementById('total_est').value = (parseInt(temp)+parseInt(est)).toFixed(2);
        document.getElementById('total_cost_'+x).value = (total1).toFixed(2);
        document.getElementById('total_unit_cost').value = (parseInt(ammt)+parseInt(temp1)).toFixed(2);
//		if (num_row == x ) {
//			document.getElementById('total_cost_'+x).value = (total1).toFixed(2);
//			var sum = 0;
//			for ($y=1; $y <= x ; $y++) {
