...
<div class="container">
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header" style= "color:#337ab7; font-size: 30px; font-family:Georgia;"><center>DELIVERY</center></h3>    
						...
						<div class="panel-heading">
							...
							<div style="float: right;">
									...
									<ul class="nav nav-pills" role="tablist">
										<li class="active"><a href="#chart1" role="tab" data-toggle="tab"><i style="color:green">Complete</i></a></li>
										<li><a href="#chart2" role="tab" data-toggle="tab"><i style="color:red">Partial</i></a></li>
                			...
                			<div class="tab-content">
								<div class="tab-pane fade in active" id="chart1">
										...
										<?php
								include "delivery_rec/complete.php";
								?>
										</div>
							<!--chart1-->
							...
							<div class="tab-pane fade" id="chart2">
								...
								<?php
								include "delivery_rec/partial.php";
								?>
								</div>
							<!--chart2-->
