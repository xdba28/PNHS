                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            <table width="100%" class="table table-striped table-bordered table-hover" border='2' id="dataTables-example">
												...
												<?php if ($iar_status['iar_status'] == 'Partial') { ?>
													<thead>
														<tr class="info">
    ...
    <div class="modal-dialog" style="opacity: 1; display: block; transform: perspective(400px) scaleX(1) scaleY(1) translateX(0px); transform-origin: calc(0px + 50%) 50% 0px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<input type="hidden" name="stat" value="Complete"></input>
            </div>
            ...
            <?php 
                if(isset($_POST['go'])){
                    ...
                    if($inspo){
                        ...
                        mysqli_query($mysqli,"COMMIT");
                        echo "<script>alert('IAR Added!'); window.location='create_iar_partial.php?iar=$iar&po=$po&pr=$pr&ris=$ris';</script>";
                    }else{
                        mysqli_query($mysqli,"ROLLBACK");
                        echo "<script>alert('PO Error!'); window.location='create_iar_partial.php?pr=$pr&ris=$ris';</script>";
                    }
                    mysqli_query($mysqli,"UNLOCK TABLES");
                }
            ?>
