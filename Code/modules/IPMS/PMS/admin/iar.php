  ...
  ?>
    <div id="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
				<br>
                <h3 class="page-header" style = "color:#337ab7; font-size: 30px; font-family:Georgia;"><center>IAR RECORDS</center></h3>	
				</div>
			</div>
            <br>
						...
						<div class="panel-heading">
							...
							<div style="float: right;">
									...
									<ul class="nav nav-pills" role="tablist">
										...
										<li><a href="#chart2" role="tab" data-toggle="tab"><i style="color:green">Complete</i></a></li>
										<li><a href="#chart3" role="tab" data-toggle="tab"><i style="color:blue">Partial</i></a></li>
										&nbsp;&nbsp;&nbsp;
									</ul><br>
                			</div><br><br>
