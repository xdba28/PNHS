...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO `equipment`(`eqp_name`, `eqp_description`, `eqp_prod_num`, `eqp_unit`, `eqp_value`, `eqp_officer`, `eqp_type`, `useful_life`) VALUES ('$data[1]','$data[2]','$data[3]','$data[4]','$data[5]','$data[6]','Clinic','$data[7]')";
    try{
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Cinic Equipment</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form action="addecl.php" method="post">
