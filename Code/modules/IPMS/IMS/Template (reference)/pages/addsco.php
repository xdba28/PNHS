...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO `supply`(`supp_name`, `supp_description`, `supp_prod_num`, `supp_unit`, `supp_value`, `supp_officer`, `supp_type`) VALUES ('$data[1]','$data[2]','$data[3]','$data[4]','$data[5]','$data[6]','Construction')";
    try{
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            </br></br></br></br></br></br><a href="adds.html"> Common</a></br>
                        </li>
                         </li>
                        <li>
                            <a href="addsj.html"> Janitorial</a></br>
                        </li>
						<li>
                            <a href="addst.html"> T.L.E.</a></br>
                        </li>
						<li>
                            <a href="addsel.html"> Electric</a></br>
                        </li>
						<li>
                            <a href="addsco.html"> Construction</a></br>
                        </li>
						<li>
                            <a href="addscl.html"> Clinic</a></br>
                        </li>
                         </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Construction Supply</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form action="addsco.php" method="post">
