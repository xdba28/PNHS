...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO `supply`(`supp_name`, `supp_description`, `supp_prod_num`, `supp_unit`, `supp_value`, `supp_officer`, `supp_type`) VALUES ('$data[1]','$data[2]','$data[3]','$data[4]','$data[5]','$data[6]','Janitorial')";
    try{
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Janitorial Supply</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form action="addsj.php" method="post">
