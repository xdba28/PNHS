					...
					<div class="row">
						<div class="col-lg-10">
							<div class="w3-theme-bl3 well" >
								<p align="justify"><h4> The system aims to prevent an unexpected shortage of equipment or 
								supplies. The inventory is categorized into two, 
								the supplies and the equipment. Supplies are items which can be consumed 
								while the equipment are items that are not consumed,rather they are used by the personnel of the school. The inventory is updated each time an equipment is added or borrowed so the supply officer 
								would know the available equipment for use in the following day or week. The 
								supply officer should be the only one who would access the inventory 
								system, thus making him an admin.</h4>
								</p> 													  
							</div>
							</br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="building.php" title="Building"> <img src="../docs/img/building.jpg" align="center" width="175px" height="175px"></a> &nbsp;&nbsp;&nbsp;&nbsp;
							<a href="equip.php" title="Equipment"><img src="../docs/img/equipment.jpg" align="center" width="175px" height="175px"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="supply.php" title="Supply"><img src="../docs/img/supply.jpg" align="center" width="175px" height="175px"></a> 
