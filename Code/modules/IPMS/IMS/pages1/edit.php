...
<div class="container-fluid">
	...
	<nav style="max-width:100%" class="hidden-xl hidden-lg hidden-md hidden-sm">
		<ul class="sidebar-menu">
		 ...
		 <li><a href="../pages/borrow.php"><i class="fa fa-copy"></i> Borrow </a></li>
		</ul>
	  </nav>
	</ul>  
</div><!-- /.navbar-collapse -->
        ...
        <form name="insert-data" action="" method="post">
			<div class="panel panel-primary">
			  ...
			  <div class="col-lg-6 col-lg-push-3 text-center">
				  ...
				  <label for="usr">Facility Type:</label>
				  <input type="text" class="form-control" name="type" value="<?php echo $type; ?>" id="usr">
				  </div>
				  <div class="form-group">
				  <label for="usr">Number of Storeys:</label>
				  <input type="number" class="form-control" name="storey" value="<?php echo $storey; ?>" id="usr">
				  </div>
				  <div class="form-group">
				  <label for="usr">Number of Rooms:</label>
				  <input type="number" class="form-control" name="rooms" value="<?php echo $rooms; ?>" id="usr">
				  </div>


				<div class="form-group">
				  <input a href="building.php" class="btn btn-outline btn-info btn" type="submit" name='submit' class="form-control" id="pwd">
				</div>
