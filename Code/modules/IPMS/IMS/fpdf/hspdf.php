...
class PDF extends FPDF
{
   ...
   $sql1="SELECT DISTINCT pims_personnel.P_fname, 
	...
	$this->Cell(80,5);
	$this->Cell(180,5,'TRANSACTION HISTORY REPORT',0,1,'C');
	...
	$this->Cell(40,15,'Issued',1,0,'C');
	$this->Cell(40,15,'Returned',1,0,'C');
	$this->Cell(40,15,'Transferred',1,1,'C');
...
$id=$_GET['pcode'];
   $sql="SELECT pims_personnel.emp_no,ims_borrow.trans_date,ims_borrow.return_date, ims_storage.stor_id, pms_ris_req.req_item, pms_ris_req.req_desc, pms_ris_req.req_unit, ims_borrow.borrow_qty, pims_personnel.P_fname, 
