...
if(isset($_POST['search']))
{
    ...
    $query="SELECT ims_borrow.emp_no,pms_supplier.company_name,pms_po_con.unit_cost, ims_storage.stor_id, pms_ris_req.req_item, pms_ris_req.req_desc, pms_ris_req.req_unit, ims_borrow.borrow_qty,
	...
	AND ims_storage.stor_id=ims_borrow.stor_id AND ims_storage.equipment='1' AND ims_borrow.borrow_qty > '0'
...
$en=$row['emp_no'];?>
                ...
                <?php endwhile;?>
										...
										<a  class="btn btn-outline btn-primary btn" href='borrowreport.php'>Back to Top</a></center><br>
									<!-- /.col-lg-12 -->
									</div> 
								</div><center><a href='../fpdf/brwpdf.php?pcode=<?php echo $en; ?>' class="btn btn-outline btn-primary btn"><h2><i class="fa fa-print">  Print</h2></i></a></center>
								</div>
