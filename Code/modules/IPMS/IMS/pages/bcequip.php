		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='Clinic' AND ims_storage.equipment='1' AND ims_storage.ins='0'
						  ORDER BY req_item";
		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND pms_ris_req.req_item_id=pms_pr_con.req_item_id AND pms_pr.pr_no=pms_pr_con.pr_no AND pms_supplier.company_id=pms_po.company_id AND pms_po.po_no=pms_po_con.po_no 
					  AND pms_po_con.pr_id=pms_pr_con.pr_id AND pms_iar.iar_no=pms_iar_con.iar_no AND pms_iar_con.po_id=pms_po_con.po_id AND pms_iar_con.iar_id=ims_storage.iar_id 
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='Common' AND ims_storage.equipment='1' AND ims_storage.ins='0'
					  ORDER BY req_item";
							$res=mysqli_query($mysqli,$sql);
					  while($row=mysqli_fetch_array($res))
					  { 
		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND pms_ris_req.req_item_id=pms_pr_con.req_item_id AND pms_pr.pr_no=pms_pr_con.pr_no AND pms_supplier.company_id=pms_po.company_id AND pms_po.po_no=pms_po_con.po_no 
					  AND pms_po_con.pr_id=pms_pr_con.pr_id AND pms_iar.iar_no=pms_iar_con.iar_no AND pms_iar_con.po_id=pms_po_con.po_id AND pms_iar_con.iar_id=ims_storage.iar_id 
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='Electric' AND ims_storage.equipment='1' AND ims_storage.ins='0' 
					  ORDER BY req_item";
							$res=mysqli_query($mysqli,$sql);
					  while($row=mysqli_fetch_array($res))
					  { 
		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND pms_ris_req.req_item_id=pms_pr_con.req_item_id AND pms_pr.pr_no=pms_pr_con.pr_no AND pms_supplier.company_id=pms_po.company_id AND pms_po.po_no=pms_po_con.po_no 
					  AND pms_po_con.pr_id=pms_pr_con.pr_id AND pms_iar.iar_no=pms_iar_con.iar_no AND pms_iar_con.po_id=pms_po_con.po_id AND pms_iar_con.iar_id=ims_storage.iar_id 
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='Hardware' AND ims_storage.equipment='1' AND ims_storage.ins='0' ORDER BY req_item";
							$res=mysqli_query($mysqli,$sql);
					  while($row=mysqli_fetch_array($res))
					  { 
						$names=$row['req_item'];
		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND pms_ris_req.req_item_id=pms_pr_con.req_item_id AND pms_pr.pr_no=pms_pr_con.pr_no AND pms_supplier.company_id=pms_po.company_id AND pms_po.po_no=pms_po_con.po_no 
					  AND pms_po_con.pr_id=pms_pr_con.pr_id AND pms_iar.iar_no=pms_iar_con.iar_no AND pms_iar_con.po_id=pms_po_con.po_id AND pms_iar_con.iar_id=ims_storage.iar_id 
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='I.T.' AND ims_storage.equipment='1' AND ims_storage.ins='0' ORDER BY req_item";
							$res=mysqli_query($mysqli,$sql);
					  while($row=mysqli_fetch_array($res))
					  { 
						$names=$row['req_item'];						
		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND pms_ris_req.req_item_id=pms_pr_con.req_item_id AND pms_pr.pr_no=pms_pr_con.pr_no AND pms_supplier.company_id=pms_po.company_id AND pms_po.po_no=pms_po_con.po_no 
					  AND pms_po_con.pr_id=pms_pr_con.pr_id AND pms_iar.iar_no=pms_iar_con.iar_no AND pms_iar_con.po_id=pms_po_con.po_id AND pms_iar_con.iar_id=ims_storage.iar_id 
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='Janitorial' AND ims_storage.equipment='1' AND ims_storage.ins='0' ORDER BY req_item";
							$res=mysqli_query($mysqli,$sql);
					  while($row=mysqli_fetch_array($res))
					  { 
						$names=$row['req_item'];
		...
		data: [              
		{
			...
			dataPoints: [
				<?php
					  ...
					  AND pms_ris_req.req_item_id=pms_pr_con.req_item_id AND pms_pr.pr_no=pms_pr_con.pr_no AND pms_supplier.company_id=pms_po.company_id AND pms_po.po_no=pms_po_con.po_no 
					  AND pms_po_con.pr_id=pms_pr_con.pr_id AND pms_iar.iar_no=pms_iar_con.iar_no AND pms_iar_con.po_id=pms_po_con.po_id AND pms_iar_con.iar_id=ims_storage.iar_id 
					  AND ims_storage.emp_no=pims_personnel.emp_no AND ims_storage.item_type='Sports' AND ims_storage.equipment='1' AND ims_storage.ins='0' ORDER BY req_item";
							$res=mysqli_query($mysqli,$sql);
					  while($row=mysqli_fetch_array($res))
					  { 
						$names=$row['req_item'];
